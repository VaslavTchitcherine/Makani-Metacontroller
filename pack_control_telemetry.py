...
_libraries = {}
#_libraries['control/_pack_control_telemetry.so'] = ctypes.CDLL(os.path.join(makani.HOME, 'control/_pack_control_telemetry.so'))
_libraries['control/_pack_control_telemetry.so'] = ctypes.CDLL('./lib/_pack_control_telemetry.so')
...
struct_c__SA_NovAtelLogHeadingRate._pack_ = True # source:False
struct_c__SA_NovAtelLogHeadingRate._fields_ = [
...
struct_c__SA_DetwistSensorBusInternal._pack_ = True # source:False
struct_c__SA_DetwistSensorBusInternal._fields_ = [
    ('Position', ctypes.c_double),
...
AioMessageTypeToIpAddress = _libraries['control/_pack_control_telemetry.so'].AioMessageTypeToIpAddress
AioMessageTypeToIpAddress.restype = IpAddress
AioMessageTypeToIpAddress.argtypes = [MessageType]
AioMessageTypeToEthernetAddress = _libraries['control/_pack_control_telemetry.so'].AioMessageTypeToEthernetAddress
...
WinchMessageTypeToIpAddress = _libraries['control/_pack_control_telemetry.so'].WinchMessageTypeToIpAddress
...
EopMessageTypeToIpAddress = _libraries['control/_pack_control_telemetry.so'].EopMessageTypeToIpAddress
EopMessageTypeToIpAddress.restype = IpAddress
EopMessageTypeToIpAddress.argtypes = [EopMessageType]
WinchMessageTypeToEthernetAddress = _libraries['control/_pack_control_telemetry.so'].WinchMessageTypeToEthernetAddress
WinchMessageTypeToEthernetAddress.restype = EthernetAddress
WinchMessageTypeToEthernetAddress.argtypes = [WinchMessageType]
EopMessageTypeToEthernetAddress = _libraries['control/_pack_control_telemetry.so'].EopMessageTypeToEthernetAddress
EopMessageTypeToEthernetAddress.restype = EthernetAddress
EopMessageTypeToEthernetAddress.argtypes = [EopMessageType]
IpAddressToEthernetAddress = _libraries['control/_pack_control_telemetry.so'].IpAddressToEthernetAddress
IpAddressToEthernetAddress.restype = EthernetAddress
IpAddressToEthernetAddress.argtypes = [IpAddress]
uint32_t = ctypes.c_uint32
IpAddressToUint32 = _libraries['control/_pack_control_telemetry.so'].IpAddressToUint32
IpAddressToUint32.restype = uint32_t
IpAddressToUint32.argtypes = [IpAddress]
Uint32ToIpAddress = _libraries['control/_pack_control_telemetry.so'].Uint32ToIpAddress
...
NovAtelSolutionTypeToString = _libraries['control/_pack_control_telemetry.so'].NovAtelSolutionTypeToString
NovAtelSolutionTypeToString.restype = POINTER_T(ctypes.c_char)
NovAtelSolutionTypeToString.argtypes = [NovAtelSolutionType]
NovAtelSolutionStatusToString = _libraries['control/_pack_control_telemetry.so'].NovAtelSolutionStatusToString
...
SeptentrioPvtModeToString = _libraries['control/_pack_control_telemetry.so'].SeptentrioPvtModeToString
SeptentrioPvtModeToString.restype = POINTER_T(ctypes.c_char)
SeptentrioPvtModeToString.argtypes = [SeptentrioPvtMode]
SeptentrioPvtErrorToString = _libraries['control/_pack_control_telemetry.so'].SeptentrioPvtErrorToString
...
Ads7828BuildCommand = _libraries['control/_pack_control_telemetry.so'].Ads7828BuildCommand
...
Bq34z100BusRawToVolts = _libraries['control/_pack_control_telemetry.so'].Bq34z100BusRawToVolts
Bq34z100BusRawToVolts.restype = ctypes.c_float
Bq34z100BusRawToVolts.argtypes = [uint16_t, ctypes.c_float]
Bq34z100Convert = _libraries['control/_pack_control_telemetry.so'].Bq34z100Convert
...
Ina219BuildConfig = _libraries['control/_pack_control_telemetry.so'].Ina219BuildConfig
...
Ina219BusRawToMillivolts = _libraries['control/_pack_control_telemetry.so'].Ina219BusRawToMillivolts
Ina219BusRawToMillivolts.restype = int32_t
Ina219BusRawToMillivolts.argtypes = [uint16_t]
int16_t = ctypes.c_int16
Ina219ShuntRawToAmps = _libraries['control/_pack_control_telemetry.so'].Ina219ShuntRawToAmps
Ina219ShuntRawToAmps.restype = ctypes.c_float
Ina219ShuntRawToAmps.argtypes = [int16_t, ctypes.c_float]
Ina219Convert = _libraries['control/_pack_control_telemetry.so'].Ina219Convert
...
Ltc2309BuildCommand = _libraries['control/_pack_control_telemetry.so'].Ltc2309BuildCommand
...
Ltc4151BusRawToMillivolts = _libraries['control/_pack_control_telemetry.so'].Ltc4151BusRawToMillivolts
Ltc4151BusRawToMillivolts.restype = int32_t
Ltc4151BusRawToMillivolts.argtypes = [uint16_t]
Ltc4151ShuntRawToAmps = _libraries['control/_pack_control_telemetry.so'].Ltc4151ShuntRawToAmps
Ltc4151ShuntRawToAmps.restype = ctypes.c_float
Ltc4151ShuntRawToAmps.argtypes = [int16_t, ctypes.c_float]
Ltc4151Convert = _libraries['control/_pack_control_telemetry.so'].Ltc4151Convert
...
Mcp342xBuildConfig = _libraries['control/_pack_control_telemetry.so'].Mcp342xBuildConfig
...
Mcp9800BuildConfig = _libraries['control/_pack_control_telemetry.so'].Mcp9800BuildConfig
Mcp9800BuildConfig.restype = uint8_t
Mcp9800BuildConfig.argtypes = [Mcp9800Resolution]
Mcp9800TempRawToC = _libraries['control/_pack_control_telemetry.so'].Mcp9800TempRawToC
...
Si7021BuildUserReg1 = _libraries['control/_pack_control_telemetry.so'].Si7021BuildUserReg1
Si7021BuildUserReg1.restype = uint8_t
Si7021BuildUserReg1.argtypes = [Si7021Resolution]
Si7021RelHumidityRawToPercent = _libraries['control/_pack_control_telemetry.so'].Si7021RelHumidityRawToPercent
Si7021RelHumidityRawToPercent.restype = ctypes.c_float
Si7021RelHumidityRawToPercent.argtypes = [uint16_t]
Si7021TempRawToC = _libraries['control/_pack_control_telemetry.so'].Si7021TempRawToC
Si7021TempRawToC.restype = ctypes.c_float
Si7021TempRawToC.argtypes = [uint16_t]
Si7021Convert = _libraries['control/_pack_control_telemetry.so'].Si7021Convert
...
Hpf = _libraries['control/_pack_control_telemetry.so'].Hpf
...
Diff = _libraries['control/_pack_control_telemetry.so'].Diff
Diff.restype = ctypes.c_double
Diff.argtypes = [ctypes.c_double, ctypes.c_double, POINTER_T(ctypes.c_double)]
DiffVec3 = _libraries['control/_pack_control_telemetry.so'].DiffVec3
...
DiffCircular = _libraries['control/_pack_control_telemetry.so'].DiffCircular
...
RateLimit = _libraries['control/_pack_control_telemetry.so'].RateLimit
...
RateLimitInt32 = _libraries['control/_pack_control_telemetry.so'].RateLimitInt32
RateLimitInt32.restype = int32_t
RateLimitInt32.argtypes = [int32_t, int32_t, int32_t, ctypes.c_double, POINTER_T(ctypes.c_int32)]
RateLimitVec3 = _libraries['control/_pack_control_telemetry.so'].RateLimitVec3
...
RateLimitCircular = _libraries['control/_pack_control_telemetry.so'].RateLimitCircular
...
Filter = _libraries['control/_pack_control_telemetry.so'].Filter
...
FilterCircularBuffer = _libraries['control/_pack_control_telemetry.so'].FilterCircularBuffer
...
HoldMax = _libraries['control/_pack_control_telemetry.so'].HoldMax
...
LatchOn = _libraries['control/_pack_control_telemetry.so'].LatchOn
LatchOn.restype = ctypes.c_bool
LatchOn.argtypes = [int32_t, ctypes.c_double, ctypes.c_double, POINTER_T(ctypes.c_int32)]
Zoh = _libraries['control/_pack_control_telemetry.so'].Zoh
...
Pid = _libraries['control/_pack_control_telemetry.so'].Pid
...
PidAntiWindup = _libraries['control/_pack_control_telemetry.so'].PidAntiWindup
...
CrossfadePidParams = _libraries['control/_pack_control_telemetry.so'].CrossfadePidParams
...
SecondOrderFilterCoeff = _libraries['control/_pack_control_telemetry.so'].SecondOrderFilterCoeff
...
Lpf2Init = _libraries['control/_pack_control_telemetry.so'].Lpf2Init
Lpf2Init.restype = None
Lpf2Init.argtypes = [ctypes.c_double, ctypes.c_double, ctypes.c_double, ctypes.c_double, ctypes.c_double * 0]
Lpf2Vec3Init = _libraries['control/_pack_control_telemetry.so'].Lpf2Vec3Init
...
Lpf2 = _libraries['control/_pack_control_telemetry.so'].Lpf2
...
Hpf2 = _libraries['control/_pack_control_telemetry.so'].Hpf2
...
BandPass2 = _libraries['control/_pack_control_telemetry.so'].BandPass2
...
DiffLpf2 = _libraries['control/_pack_control_telemetry.so'].DiffLpf2
...
Lpf2Vec3 = _libraries['control/_pack_control_telemetry.so'].Lpf2Vec3
...
Hpf2Vec3 = _libraries['control/_pack_control_telemetry.so'].Hpf2Vec3
...
BandPass2Vec3 = _libraries['control/_pack_control_telemetry.so'].BandPass2Vec3
...
DiffLpf2Vec3 = _libraries['control/_pack_control_telemetry.so'].DiffLpf2Vec3
...
PeakDetector = _libraries['control/_pack_control_telemetry.so'].PeakDetector
...
PeakDetectorVec3 = _libraries['control/_pack_control_telemetry.so'].PeakDetectorVec3
...
InitCircularAveragingBuffer = _libraries['control/_pack_control_telemetry.so'].InitCircularAveragingBuffer
...
UpdateCircularAveragingBuffer = _libraries['control/_pack_control_telemetry.so'].UpdateCircularAveragingBuffer
...
DcmToAngle = _libraries['control/_pack_control_telemetry.so'].DcmToAngle
...
AngleToDcm = _libraries['control/_pack_control_telemetry.so'].AngleToDcm
...
CartToSph = _libraries['control/_pack_control_telemetry.so'].CartToSph
...
SphToCart = _libraries['control/_pack_control_telemetry.so'].SphToCart
...
CartToCyl = _libraries['control/_pack_control_telemetry.so'].CartToCyl
...
CylToCart = _libraries['control/_pack_control_telemetry.so'].CylToCart
...
PoseTransform = _libraries['control/_pack_control_telemetry.so'].PoseTransform
...
InversePoseTransform = _libraries['control/_pack_control_telemetry.so'].InversePoseTransform
...
Vec3ToAxisAngle = _libraries['control/_pack_control_telemetry.so'].Vec3ToAxisAngle
...
ProjectVec3ToPlane = _libraries['control/_pack_control_telemetry.so'].ProjectVec3ToPlane
...
Vec2ToAngle = _libraries['control/_pack_control_telemetry.so'].Vec2ToAngle
Vec2ToAngle.restype = ctypes.c_double
Vec2ToAngle.argtypes = [POINTER_T(struct_Vec2), POINTER_T(struct_Vec2)]
IntersectLinePlane = _libraries['control/_pack_control_telemetry.so'].IntersectLinePlane
...
SignedAngleBetweenVectors = _libraries['control/_pack_control_telemetry.so'].SignedAngleBetweenVectors
...
BoundedKalman1d = _libraries['control/_pack_control_telemetry.so'].BoundedKalman1d
...
BoundedKalman1dEstimator = _libraries['control/_pack_control_telemetry.so'].BoundedKalman1dEstimator
...
UdKalmanExtractUd = _libraries['control/_pack_control_telemetry.so'].UdKalmanExtractUd
...
UdKalmanStoreUpperTri = _libraries['control/_pack_control_telemetry.so'].UdKalmanStoreUpperTri
...
UdKalmanCalcWeightVectors = _libraries['control/_pack_control_telemetry.so'].UdKalmanCalcWeightVectors
...
UdKalmanCalcGain = _libraries['control/_pack_control_telemetry.so'].UdKalmanCalcGain
...
UdKalmanMeasurementUpdate = _libraries['control/_pack_control_telemetry.so'].UdKalmanMeasurementUpdate
...
UdKalmanTimeUpdate = _libraries['control/_pack_control_telemetry.so'].UdKalmanTimeUpdate
...
UdKalmanExtractCovariances = _libraries['control/_pack_control_telemetry.so'].UdKalmanExtractCovariances
UdKalmanExtractCovariances.restype = None
UdKalmanExtractCovariances.argtypes = [ctypes.c_double * 0, POINTER_T(struct_c__SA_Vec)]
UdKalmanTransitionMatrixMultiply = _libraries['control/_pack_control_telemetry.so'].UdKalmanTransitionMatrixMultiply
...
VecAdd = _libraries['control/_pack_control_telemetry.so'].VecAdd
...
VecAdd3 = _libraries['control/_pack_control_telemetry.so'].VecAdd3
...
VecSub = _libraries['control/_pack_control_telemetry.so'].VecSub
...
VecLinComb = _libraries['control/_pack_control_telemetry.so'].VecLinComb
...
VecLinComb3 = _libraries['control/_pack_control_telemetry.so'].VecLinComb3
...
VecMult = _libraries['control/_pack_control_telemetry.so'].VecMult
...
VecSlice = _libraries['control/_pack_control_telemetry.so'].VecSlice
...
VecSliceSet = _libraries['control/_pack_control_telemetry.so'].VecSliceSet
...
MatScale = _libraries['control/_pack_control_telemetry.so'].MatScale
...
MatI = _libraries['control/_pack_control_telemetry.so'].MatI
MatI.restype = POINTER_T(struct_c__SA_Mat)
MatI.argtypes = [int32_t, POINTER_T(struct_c__SA_Mat)]
MatMult = _libraries['control/_pack_control_telemetry.so'].MatMult
...
MatVecGenMult = _libraries['control/_pack_control_telemetry.so'].MatVecGenMult
...
MatGenMult = _libraries['control/_pack_control_telemetry.so'].MatGenMult
...
MatMult3 = _libraries['control/_pack_control_telemetry.so'].MatMult3
...
MatVecMult = _libraries['control/_pack_control_telemetry.so'].MatVecMult
...
MatTransVecMult = _libraries['control/_pack_control_telemetry.so'].MatTransVecMult
...
MatTrans = _libraries['control/_pack_control_telemetry.so'].MatTrans
MatTrans.restype = POINTER_T(struct_c__SA_Mat)
MatTrans.argtypes = [POINTER_T(struct_c__SA_Mat), POINTER_T(struct_c__SA_Mat)]
MatAdd = _libraries['control/_pack_control_telemetry.so'].MatAdd
...
MatSub = _libraries['control/_pack_control_telemetry.so'].MatSub
...
MatQrDecomp = _libraries['control/_pack_control_telemetry.so'].MatQrDecomp
...
MatThinSvDecomp = _libraries['control/_pack_control_telemetry.so'].MatThinSvDecomp
...
MatRank = _libraries['control/_pack_control_telemetry.so'].MatRank
MatRank.restype = int32_t
MatRank.argtypes = [POINTER_T(struct_c__SA_Mat), ctypes.c_double]
MatVecLeftDivide = _libraries['control/_pack_control_telemetry.so'].MatVecLeftDivide
...
MatVecRightDivide = _libraries['control/_pack_control_telemetry.so'].MatVecRightDivide
...
MatMatLeftDivide = _libraries['control/_pack_control_telemetry.so'].MatMatLeftDivide
...
MatMatRightDivide = _libraries['control/_pack_control_telemetry.so'].MatMatRightDivide
...
MatIsUpperTriangular = _libraries['control/_pack_control_telemetry.so'].MatIsUpperTriangular
MatIsUpperTriangular.restype = ctypes.c_bool
MatIsUpperTriangular.argtypes = [POINTER_T(struct_c__SA_Mat)]
MatIsLowerTriangular = _libraries['control/_pack_control_telemetry.so'].MatIsLowerTriangular
MatIsLowerTriangular.restype = ctypes.c_bool
MatIsLowerTriangular.argtypes = [POINTER_T(struct_c__SA_Mat)]
MatHasNonnegDiag = _libraries['control/_pack_control_telemetry.so'].MatHasNonnegDiag
MatHasNonnegDiag.restype = ctypes.c_bool
MatHasNonnegDiag.argtypes = [POINTER_T(struct_c__SA_Mat)]
MatSqrtSum = _libraries['control/_pack_control_telemetry.so'].MatSqrtSum
...
MatMatBackSub = _libraries['control/_pack_control_telemetry.so'].MatMatBackSub
...
MatMatForwardSub = _libraries['control/_pack_control_telemetry.so'].MatMatForwardSub
...
MatVecBackSub = _libraries['control/_pack_control_telemetry.so'].MatVecBackSub
...
MatVecForwardSub = _libraries['control/_pack_control_telemetry.so'].MatVecForwardSub
...
MatSlice = _libraries['control/_pack_control_telemetry.so'].MatSlice
...
MatArrMult = _libraries['control/_pack_control_telemetry.so'].MatArrMult
...
MatArrGemv = _libraries['control/_pack_control_telemetry.so'].MatArrGemv
...
MatArrGemm = _libraries['control/_pack_control_telemetry.so'].MatArrGemm
...
MatArrIsUpperTriangular = _libraries['control/_pack_control_telemetry.so'].MatArrIsUpperTriangular
MatArrIsUpperTriangular.restype = ctypes.c_bool
MatArrIsUpperTriangular.argtypes = [POINTER_T(ctypes.c_double), int32_t, int32_t]
MatArrIsLowerTriangular = _libraries['control/_pack_control_telemetry.so'].MatArrIsLowerTriangular
MatArrIsLowerTriangular.restype = ctypes.c_bool
MatArrIsLowerTriangular.argtypes = [POINTER_T(ctypes.c_double), int32_t, int32_t]
MatArrBackSub = _libraries['control/_pack_control_telemetry.so'].MatArrBackSub
...
MatArrForwardSub = _libraries['control/_pack_control_telemetry.so'].MatArrForwardSub
...
Mat2 = struct_Mat2
kMat2Zero = (struct_Mat2).in_dll(_libraries['control/_pack_control_telemetry.so'], 'kMat2Zero')
kMat2Identity = (struct_Mat2).in_dll(_libraries['control/_pack_control_telemetry.so'], 'kMat2Identity')
MAT2_DISP = ['(', 'm', ')', 'printf', '(', '"%s:%u %s = [%.12f, %.12f; %.12f, %.12f]\\n"', ',', '__FILE__', ',', '__LINE__', ',', '#', 'm', ',', '(', 'm', ')', '.', 'd', '[', '0', ']', '[', '0', ']', ',', '(', 'm', ')', '.', 'd', '[', '0', ']', '[', '1', ']', ',', '(', 'm', ')', '.', 'd', '[', '1', ']', '[', '0', ']', ',', '(', 'm', ')', '.', 'd', '[', '1', ']', '[', '1', ']', ')', ';'] # macro
Mat2Scale = _libraries['control/_pack_control_telemetry.so'].Mat2Scale
Mat2Scale.restype = POINTER_T(struct_Mat2)
Mat2Scale.argtypes = [POINTER_T(struct_Mat2), ctypes.c_double, POINTER_T(struct_Mat2)]
Mat2Vec2Axpby = _libraries['control/_pack_control_telemetry.so'].Mat2Vec2Axpby
...
Mat2Abpyc = _libraries['control/_pack_control_telemetry.so'].Mat2Abpyc
...
Mat2Add = _libraries['control/_pack_control_telemetry.so'].Mat2Add
...
Mat2Mult = _libraries['control/_pack_control_telemetry.so'].Mat2Mult
...
Mat2Vec2Mult = _libraries['control/_pack_control_telemetry.so'].Mat2Vec2Mult
...
Mat2TransVec2Mult = _libraries['control/_pack_control_telemetry.so'].Mat2TransVec2Mult
...
Mat2Det = _libraries['control/_pack_control_telemetry.so'].Mat2Det
Mat2Det.restype = ctypes.c_double
Mat2Det.argtypes = [POINTER_T(struct_Mat2)]
Mat2Inv = _libraries['control/_pack_control_telemetry.so'].Mat2Inv
Mat2Inv.restype = POINTER_T(struct_Mat2)
Mat2Inv.argtypes = [POINTER_T(struct_Mat2), POINTER_T(struct_Mat2)]
Mat2Vec2LeftDivide = _libraries['control/_pack_control_telemetry.so'].Mat2Vec2LeftDivide
...
Mat2Trace = _libraries['control/_pack_control_telemetry.so'].Mat2Trace
Mat2Trace.restype = ctypes.c_double
Mat2Trace.argtypes = [POINTER_T(struct_Mat2)]
Mat2Diag = _libraries['control/_pack_control_telemetry.so'].Mat2Diag
Mat2Diag.restype = POINTER_T(struct_Vec2)
Mat2Diag.argtypes = [POINTER_T(struct_Mat2), POINTER_T(struct_Vec2)]
Mat2Trans = _libraries['control/_pack_control_telemetry.so'].Mat2Trans
...
kMat3Zero = (struct_Mat3).in_dll(_libraries['control/_pack_control_telemetry.so'], 'kMat3Zero')
kMat3Identity = (struct_Mat3).in_dll(_libraries['control/_pack_control_telemetry.so'], 'kMat3Identity')
...
Mat3Scale = _libraries['control/_pack_control_telemetry.so'].Mat3Scale
Mat3Scale.restype = POINTER_T(struct_Mat3)
Mat3Scale.argtypes = [POINTER_T(struct_Mat3), ctypes.c_double, POINTER_T(struct_Mat3)]
Mat3Vec3Axpby = _libraries['control/_pack_control_telemetry.so'].Mat3Vec3Axpby
...
Mat3Abpyc = _libraries['control/_pack_control_telemetry.so'].Mat3Abpyc
...
Mat3Add = _libraries['control/_pack_control_telemetry.so'].Mat3Add
...
Mat3Mult = _libraries['control/_pack_control_telemetry.so'].Mat3Mult
...
Mat3Vec3Mult = _libraries['control/_pack_control_telemetry.so'].Mat3Vec3Mult
...
Mat3TransVec3Mult = _libraries['control/_pack_control_telemetry.so'].Mat3TransVec3Mult
...
Mat3Mat3Mult = _libraries['control/_pack_control_telemetry.so'].Mat3Mat3Mult
...
Mat3Det = _libraries['control/_pack_control_telemetry.so'].Mat3Det
Mat3Det.restype = ctypes.c_double
Mat3Det.argtypes = [POINTER_T(struct_Mat3)]
Mat3Inv = _libraries['control/_pack_control_telemetry.so'].Mat3Inv
Mat3Inv.restype = POINTER_T(struct_Mat3)
Mat3Inv.argtypes = [POINTER_T(struct_Mat3), POINTER_T(struct_Mat3)]
Mat3Vec3LeftDivide = _libraries['control/_pack_control_telemetry.so'].Mat3Vec3LeftDivide
...
QuatLinComb3 = _libraries['control/_pack_control_telemetry.so'].QuatLinComb3
...
QuatDivide = _libraries['control/_pack_control_telemetry.so'].QuatDivide
...
AngleToQuat = _libraries['control/_pack_control_telemetry.so'].AngleToQuat
...
QuatToMrp = _libraries['control/_pack_control_telemetry.so'].QuatToMrp
QuatToMrp.restype = None
QuatToMrp.argtypes = [POINTER_T(struct_Quat), POINTER_T(struct_Vec3)]
MrpToQuat = _libraries['control/_pack_control_telemetry.so'].MrpToQuat
MrpToQuat.restype = None
MrpToQuat.argtypes = [POINTER_T(struct_Vec3), POINTER_T(struct_Quat)]
Vec3Vec3ToDcm = _libraries['control/_pack_control_telemetry.so'].Vec3Vec3ToDcm
...
MinInt32 = _libraries['control/_pack_control_telemetry.so'].MinInt32
MinInt32.restype = int32_t
MinInt32.argtypes = [int32_t, int32_t]
MaxInt32 = _libraries['control/_pack_control_telemetry.so'].MaxInt32
MaxInt32.restype = int32_t
MaxInt32.argtypes = [int32_t, int32_t]
MinUint32 = _libraries['control/_pack_control_telemetry.so'].MinUint32
MinUint32.restype = uint32_t
MinUint32.argtypes = [uint32_t, uint32_t]
MaxUint32 = _libraries['control/_pack_control_telemetry.so'].MaxUint32
MaxUint32.restype = uint32_t
MaxUint32.argtypes = [uint32_t, uint32_t]
int64_t = ctypes.c_int64
MinInt64 = _libraries['control/_pack_control_telemetry.so'].MinInt64
MinInt64.restype = int64_t
MinInt64.argtypes = [int64_t, int64_t]
MaxInt64 = _libraries['control/_pack_control_telemetry.so'].MaxInt64
MaxInt64.restype = int64_t
MaxInt64.argtypes = [int64_t, int64_t]
uint64_t = ctypes.c_uint64
MinUint64 = _libraries['control/_pack_control_telemetry.so'].MinUint64
MinUint64.restype = uint64_t
MinUint64.argtypes = [uint64_t, uint64_t]
MaxUint64 = _libraries['control/_pack_control_telemetry.so'].MaxUint64
MaxUint64.restype = uint64_t
MaxUint64.argtypes = [uint64_t, uint64_t]
MaxUnsignedValue = _libraries['control/_pack_control_telemetry.so'].MaxUnsignedValue
MaxUnsignedValue.restype = uint32_t
MaxUnsignedValue.argtypes = [int32_t]
MinSignedValue = _libraries['control/_pack_control_telemetry.so'].MinSignedValue
MinSignedValue.restype = int32_t
MinSignedValue.argtypes = [int32_t]
MaxSignedValue = _libraries['control/_pack_control_telemetry.so'].MaxSignedValue
MaxSignedValue.restype = int32_t
MaxSignedValue.argtypes = [int32_t]
Sign = _libraries['control/_pack_control_telemetry.so'].Sign
Sign.restype = int32_t
Sign.argtypes = [ctypes.c_double]
SignInt32 = _libraries['control/_pack_control_telemetry.so'].SignInt32
SignInt32.restype = int32_t
SignInt32.argtypes = [int32_t]
IsApproximatelyEqual = _libraries['control/_pack_control_telemetry.so'].IsApproximatelyEqual
IsApproximatelyEqual.restype = ctypes.c_bool
IsApproximatelyEqual.argtypes = [ctypes.c_double, ctypes.c_double]
IsApproximatelyEqualVec3 = _libraries['control/_pack_control_telemetry.so'].IsApproximatelyEqualVec3
...
SaturateVec3 = _libraries['control/_pack_control_telemetry.so'].SaturateVec3
...
SaturateVec3ByScalar = _libraries['control/_pack_control_telemetry.so'].SaturateVec3ByScalar
...
SaturateVec = _libraries['control/_pack_control_telemetry.so'].SaturateVec
...
SaturateArrayByScalar = _libraries['control/_pack_control_telemetry.so'].SaturateArrayByScalar
...
SaturateInt32 = _libraries['control/_pack_control_telemetry.so'].SaturateInt32
SaturateInt32.restype = int32_t
SaturateInt32.argtypes = [int32_t, int32_t, int32_t]
SaturateUint32 = _libraries['control/_pack_control_telemetry.so'].SaturateUint32
SaturateUint32.restype = uint32_t
SaturateUint32.argtypes = [uint32_t, uint32_t, uint32_t]
SaturateInt64 = _libraries['control/_pack_control_telemetry.so'].SaturateInt64
SaturateInt64.restype = int64_t
SaturateInt64.argtypes = [int64_t, int64_t, int64_t]
SaturateUint64 = _libraries['control/_pack_control_telemetry.so'].SaturateUint64
SaturateUint64.restype = uint64_t
SaturateUint64.argtypes = [uint64_t, uint64_t, uint64_t]
SaturateSigned = _libraries['control/_pack_control_telemetry.so'].SaturateSigned
SaturateSigned.restype = int32_t
SaturateSigned.argtypes = [int32_t, int32_t]
SaturateUnsigned = _libraries['control/_pack_control_telemetry.so'].SaturateUnsigned
SaturateUnsigned.restype = uint32_t
SaturateUnsigned.argtypes = [uint32_t, int32_t]
SaturateWrapped = _libraries['control/_pack_control_telemetry.so'].SaturateWrapped
...
CrossfadeVec2 = _libraries['control/_pack_control_telemetry.so'].CrossfadeVec2
...
CrossfadeVec3 = _libraries['control/_pack_control_telemetry.so'].CrossfadeVec3
...
CrossfadeMat3 = _libraries['control/_pack_control_telemetry.so'].CrossfadeMat3
...
CrossfadeArray = _libraries['control/_pack_control_telemetry.so'].CrossfadeArray
...
InterpIndex = _libraries['control/_pack_control_telemetry.so'].InterpIndex
...
Interp1 = _libraries['control/_pack_control_telemetry.so'].Interp1
Interp1.restype = ctypes.c_double
Interp1.argtypes = [ctypes.c_double * 0, ctypes.c_double * 0, int32_t, ctypes.c_double, InterpOption]
Interp1WarpY = _libraries['control/_pack_control_telemetry.so'].Interp1WarpY
...
Interp2 = _libraries['control/_pack_control_telemetry.so'].Interp2
...
CircularInterp1 = _libraries['control/_pack_control_telemetry.so'].CircularInterp1
...
Interp1Vec3 = _libraries['control/_pack_control_telemetry.so'].Interp1Vec3
...
Asin = _libraries['control/_pack_control_telemetry.so'].Asin
Asin.restype = ctypes.c_double
Asin.argtypes = [ctypes.c_double]
Acos = _libraries['control/_pack_control_telemetry.so'].Acos
Acos.restype = ctypes.c_double
Acos.argtypes = [ctypes.c_double]
Sqrt = _libraries['control/_pack_control_telemetry.so'].Sqrt
Sqrt.restype = ctypes.c_double
Sqrt.argtypes = [ctypes.c_double]
Square = _libraries['control/_pack_control_telemetry.so'].Square
Square.restype = ctypes.c_double
Square.argtypes = [ctypes.c_double]
ThirdPower = _libraries['control/_pack_control_telemetry.so'].ThirdPower
ThirdPower.restype = ctypes.c_double
ThirdPower.argtypes = [ctypes.c_double]
FourthPower = _libraries['control/_pack_control_telemetry.so'].FourthPower
FourthPower.restype = ctypes.c_double
FourthPower.argtypes = [ctypes.c_double]
Exp10 = _libraries['control/_pack_control_telemetry.so'].Exp10
Exp10.restype = ctypes.c_double
Exp10.argtypes = [ctypes.c_double]
Slice = _libraries['control/_pack_control_telemetry.so'].Slice
Slice.restype = POINTER_T(ctypes.c_int32)
Slice.argtypes = [int32_t, int32_t, int32_t, int32_t, POINTER_T(ctypes.c_int32)]
SplitVec3Arr = _libraries['control/_pack_control_telemetry.so'].SplitVec3Arr
...
JoinVec3Arr = _libraries['control/_pack_control_telemetry.so'].JoinVec3Arr
JoinVec3Arr.restype = None
JoinVec3Arr.argtypes = [ctypes.c_double * 0, ctypes.c_double * 0, ctypes.c_double * 0, int32_t, struct_Vec3 * 0]
DegToRad = _libraries['control/_pack_control_telemetry.so'].DegToRad
DegToRad.restype = ctypes.c_double
DegToRad.argtypes = [ctypes.c_double]
RadToDeg = _libraries['control/_pack_control_telemetry.so'].RadToDeg
...
Vec2 = struct_Vec2
kVec2Zero = (struct_Vec2).in_dll(_libraries['control/_pack_control_telemetry.so'], 'kVec2Zero')
kVec2Ones = (struct_Vec2).in_dll(_libraries['control/_pack_control_telemetry.so'], 'kVec2Ones')
VEC2_DISP = ['(', 'v', ')', 'printf', '(', '"%s:%u %s = [%.12lf, %.12lf]\'\\n"', ',', '__FILE__', ',', '__LINE__', ',', '#', 'v', ',', '(', 'v', ')', '.', 'x', ',', '(', 'v', ')', '.', 'y', ')'] # macro
Vec2Add = _libraries['control/_pack_control_telemetry.so'].Vec2Add
Vec2Add.restype = POINTER_T(struct_Vec2)
Vec2Add.argtypes = [POINTER_T(struct_Vec2), POINTER_T(struct_Vec2), POINTER_T(struct_Vec2)]
Vec2Add3 = _libraries['control/_pack_control_telemetry.so'].Vec2Add3
...
Vec2LinComb3 = _libraries['control/_pack_control_telemetry.so'].Vec2LinComb3
...
Vec2Mult = _libraries['control/_pack_control_telemetry.so'].Vec2Mult
...
Vec2Dot = _libraries['control/_pack_control_telemetry.so'].Vec2Dot
Vec2Dot.restype = ctypes.c_double
Vec2Dot.argtypes = [POINTER_T(struct_Vec2), POINTER_T(struct_Vec2)]
Vec2Norm = _libraries['control/_pack_control_telemetry.so'].Vec2Norm
Vec2Norm.restype = ctypes.c_double
Vec2Norm.argtypes = [POINTER_T(struct_Vec2)]
Vec2NormBound = _libraries['control/_pack_control_telemetry.so'].Vec2NormBound
Vec2NormBound.restype = ctypes.c_double
Vec2NormBound.argtypes = [POINTER_T(struct_Vec2), ctypes.c_double]
Vec2NormSquared = _libraries['control/_pack_control_telemetry.so'].Vec2NormSquared
Vec2NormSquared.restype = ctypes.c_double
Vec2NormSquared.argtypes = [POINTER_T(struct_Vec2)]
Vec2Normalize = _libraries['control/_pack_control_telemetry.so'].Vec2Normalize
...
kVec3Zero = (struct_Vec3).in_dll(_libraries['control/_pack_control_telemetry.so'], 'kVec3Zero')
kVec3Ones = (struct_Vec3).in_dll(_libraries['control/_pack_control_telemetry.so'], 'kVec3Ones')
kVec3X = (struct_Vec3).in_dll(_libraries['control/_pack_control_telemetry.so'], 'kVec3X')
kVec3Y = (struct_Vec3).in_dll(_libraries['control/_pack_control_telemetry.so'], 'kVec3Y')
kVec3Z = (struct_Vec3).in_dll(_libraries['control/_pack_control_telemetry.so'], 'kVec3Z')
VEC3_DISP = ['(', 'v', ')', 'printf', '(', '"%s:%u %s = [%.12f, %.12f, %.12f]\'\\n"', ',', '__FILE__', ',', '__LINE__', ',', '#', 'v', ',', '(', 'v', ')', '.', 'x', ',', '(', 'v', ')', '.', 'y', ',', '(', 'v', ')', '.', 'z', ')'] # macro
Vec3Add = _libraries['control/_pack_control_telemetry.so'].Vec3Add
Vec3Add.restype = POINTER_T(struct_Vec3)
Vec3Add.argtypes = [POINTER_T(struct_Vec3), POINTER_T(struct_Vec3), POINTER_T(struct_Vec3)]
Vec3Add3 = _libraries['control/_pack_control_telemetry.so'].Vec3Add3
...
Vec3LinComb3 = _libraries['control/_pack_control_telemetry.so'].Vec3LinComb3
...
Vec3Axpy = _libraries['control/_pack_control_telemetry.so'].Vec3Axpy
Vec3Axpy.restype = POINTER_T(struct_Vec3)
Vec3Axpy.argtypes = [ctypes.c_double, POINTER_T(struct_Vec3), POINTER_T(struct_Vec3)]
Vec3Mult = _libraries['control/_pack_control_telemetry.so'].Vec3Mult
...
Vec3Cross = _libraries['control/_pack_control_telemetry.so'].Vec3Cross
...
GetStrain = _libraries['control/_pack_control_telemetry.so'].GetStrain
GetStrain.restype = ctypes.c_float
GetStrain.argtypes = [struct_c__SA_LoadcellMessage * 0, POINTER_T(struct_c__SA_StrainLocation)]
GetMutableStrain = _libraries['control/_pack_control_telemetry.so'].GetMutableStrain
...
GetControlDebugMessage = _libraries['control/_pack_control_telemetry.so'].GetControlDebugMessage
GetControlDebugMessage.restype = POINTER_T(struct_c__SA_ControlTelemetry)
GetControlDebugMessage.argtypes = []
GetSmallControlTelemetry = _libraries['control/_pack_control_telemetry.so'].GetSmallControlTelemetry
GetSmallControlTelemetry.restype = POINTER_T(struct_c__SA_TetherControlTelemetry)
GetSmallControlTelemetry.argtypes = []
GetControlSlowTelemetry = _libraries['control/_pack_control_telemetry.so'].GetControlSlowTelemetry
GetControlSlowTelemetry.restype = POINTER_T(struct_c__SA_ControlSlowTelemetry)
GetControlSlowTelemetry.argtypes = []
GetControlTelemetry = _libraries['control/_pack_control_telemetry.so'].GetControlTelemetry
GetControlTelemetry.restype = POINTER_T(struct_c__SA_ControlTelemetry)
GetControlTelemetry.argtypes = []
GetEstimatorTelemetry = _libraries['control/_pack_control_telemetry.so'].GetEstimatorTelemetry
GetEstimatorTelemetry.restype = POINTER_T(struct_c__SA_EstimatorTelemetry)
GetEstimatorTelemetry.argtypes = []
GetHoverTelemetry = _libraries['control/_pack_control_telemetry.so'].GetHoverTelemetry
GetHoverTelemetry.restype = POINTER_T(struct_c__SA_HoverTelemetry)
GetHoverTelemetry.argtypes = []
GetManualTelemetry = _libraries['control/_pack_control_telemetry.so'].GetManualTelemetry
GetManualTelemetry.restype = POINTER_T(struct_c__SA_ManualTelemetry)
GetManualTelemetry.argtypes = []
GetTransInTelemetry = _libraries['control/_pack_control_telemetry.so'].GetTransInTelemetry
GetTransInTelemetry.restype = POINTER_T(struct_c__SA_TransInTelemetry)
GetTransInTelemetry.argtypes = []
GetCrosswindTelemetry = _libraries['control/_pack_control_telemetry.so'].GetCrosswindTelemetry
GetCrosswindTelemetry.restype = POINTER_T(struct_c__SA_CrosswindTelemetry)
GetCrosswindTelemetry.argtypes = []
GetSyncTelemetry = _libraries['control/_pack_control_telemetry.so'].GetSyncTelemetry
GetSyncTelemetry.restype = POINTER_T(struct_c__SA_SyncTelemetry)
GetSyncTelemetry.argtypes = []
GetQ7SlowStatusMessage = _libraries['control/_pack_control_telemetry.so'].GetQ7SlowStatusMessage
GetQ7SlowStatusMessage.restype = POINTER_T(struct_c__SA_Q7SlowStatusMessage)
GetQ7SlowStatusMessage.argtypes = []
ControlTelemetryToSmallControlTelemetryMessage = _libraries['control/_pack_control_telemetry.so'].ControlTelemetryToSmallControlTelemetryMessage
...
GetNumFlightModeGates = _libraries['control/_pack_control_telemetry.so'].GetNumFlightModeGates
GetNumFlightModeGates.restype = int32_t
GetNumFlightModeGates.argtypes = [FlightMode]
InitializationStateToString = _libraries['control/_pack_control_telemetry.so'].InitializationStateToString
InitializationStateToString.restype = POINTER_T(ctypes.c_char)
InitializationStateToString.argtypes = [InitializationState]
FlightModeToString = _libraries['control/_pack_control_telemetry.so'].FlightModeToString
...
CrosswindNormalGateToString = _libraries['control/_pack_control_telemetry.so'].CrosswindNormalGateToString
CrosswindNormalGateToString.restype = POINTER_T(ctypes.c_char)
CrosswindNormalGateToString.argtypes = [CrosswindNormalGate]
CrosswindPrepTransOutGateToString = _libraries['control/_pack_control_telemetry.so'].CrosswindPrepTransOutGateToString
...
CrosswindHoverTransOutGateToString = _libraries['control/_pack_control_telemetry.so'].CrosswindHoverTransOutGateToString
...
ApparentWindSolutionTypeToString = _libraries['control/_pack_control_telemetry.so'].ApparentWindSolutionTypeToString
...
ExperimentTypeToString = _libraries['control/_pack_control_telemetry.so'].ExperimentTypeToString
...
GetWingGpsPosFault = _libraries['control/_pack_control_telemetry.so'].GetWingGpsPosFault
...
GetWingGpsVelFault = _libraries['control/_pack_control_telemetry.so'].GetWingGpsVelFault
...
HoverAscendGateToString = _libraries['control/_pack_control_telemetry.so'].HoverAscendGateToString
HoverAscendGateToString.restype = POINTER_T(ctypes.c_char)
HoverAscendGateToString.argtypes = [HoverAscendGate]
HoverPayOutGateToString = _libraries['control/_pack_control_telemetry.so'].HoverPayOutGateToString
HoverPayOutGateToString.restype = POINTER_T(ctypes.c_char)
HoverPayOutGateToString.argtypes = [HoverPayOutGate]
HoverFullLengthGateToString = _libraries['control/_pack_control_telemetry.so'].HoverFullLengthGateToString
HoverFullLengthGateToString.restype = POINTER_T(ctypes.c_char)
HoverFullLengthGateToString.argtypes = [HoverFullLengthGate]
HoverPrepTransformGsUpGateToString = _libraries['control/_pack_control_telemetry.so'].HoverPrepTransformGsUpGateToString
...
HoverTransformGsUpGateToString = _libraries['control/_pack_control_telemetry.so'].HoverTransformGsUpGateToString
...
HoverAccelGateToString = _libraries['control/_pack_control_telemetry.so'].HoverAccelGateToString
HoverAccelGateToString.restype = POINTER_T(ctypes.c_char)
HoverAccelGateToString.argtypes = [HoverAccelGate]
HoverPrepTransformGsDownGateToString = _libraries['control/_pack_control_telemetry.so'].HoverPrepTransformGsDownGateToString
...
HoverTransformGsDownGateToString = _libraries['control/_pack_control_telemetry.so'].HoverTransformGsDownGateToString
...
HoverReelInGateToString = _libraries['control/_pack_control_telemetry.so'].HoverReelInGateToString
HoverReelInGateToString.restype = POINTER_T(ctypes.c_char)
HoverReelInGateToString.argtypes = [HoverReelInGate]
HoverDescendGateToString = _libraries['control/_pack_control_telemetry.so'].HoverDescendGateToString
HoverDescendGateToString.restype = POINTER_T(ctypes.c_char)
HoverDescendGateToString.argtypes = [HoverDescendGate]
HoverPerchedGateToString = _libraries['control/_pack_control_telemetry.so'].HoverPerchedGateToString
...
FlightPlanToString = _libraries['control/_pack_control_telemetry.so'].FlightPlanToString
FlightPlanToString.restype = POINTER_T(ctypes.c_char)
FlightPlanToString.argtypes = [FlightPlan]
GroundStationModelToString = _libraries['control/_pack_control_telemetry.so'].GroundStationModelToString
GroundStationModelToString.restype = POINTER_T(ctypes.c_char)
GroundStationModelToString.argtypes = [GroundStationModel]
TestSiteToString = _libraries['control/_pack_control_telemetry.so'].TestSiteToString
TestSiteToString.restype = POINTER_T(ctypes.c_char)
TestSiteToString.argtypes = [TestSite]
WingSerialToString = _libraries['control/_pack_control_telemetry.so'].WingSerialToString
WingSerialToString.restype = POINTER_T(ctypes.c_char)
WingSerialToString.argtypes = [WingSerial]
WingSerialToModel = _libraries['control/_pack_control_telemetry.so'].WingSerialToModel
WingSerialToModel.restype = ctypes.c_int32
WingSerialToModel.argtypes = [WingSerial]
IsLowAltitudeFlightPlan = _libraries['control/_pack_control_telemetry.so'].IsLowAltitudeFlightPlan
...
BridleAndChannelToLoadcellSensorLabel = _libraries['control/_pack_control_telemetry.so'].BridleAndChannelToLoadcellSensorLabel
...
TransInGateToString = _libraries['control/_pack_control_telemetry.so'].TransInGateToString
...
CONTROL_PACK_CONTROL_TELEMETRY_H_ = True
PACK_CONTROLDEBUGMESSAGE_SIZE = 11514
size_t = ctypes.c_uint64
PackControlDebugMessage = _libraries['control/_pack_control_telemetry.so'].PackControlDebugMessage
PackControlDebugMessage.restype = size_t
PackControlDebugMessage.argtypes = [POINTER_T(struct_c__SA_ControlTelemetry), size_t, POINTER_T(ctypes.c_ubyte)]
UnpackControlDebugMessage = _libraries['control/_pack_control_telemetry.so'].UnpackControlDebugMessage
UnpackControlDebugMessage.restype = size_t
UnpackControlDebugMessage.argtypes = [POINTER_T(ctypes.c_ubyte), size_t, POINTER_T(struct_c__SA_ControlTelemetry)]
PACK_CONTROLSLOWTELEMETRY_SIZE = 156
PackControlSlowTelemetry = _libraries['control/_pack_control_telemetry.so'].PackControlSlowTelemetry
PackControlSlowTelemetry.restype = size_t
PackControlSlowTelemetry.argtypes = [POINTER_T(struct_c__SA_ControlSlowTelemetry), size_t, POINTER_T(ctypes.c_ubyte)]
UnpackControlSlowTelemetry = _libraries['control/_pack_control_telemetry.so'].UnpackControlSlowTelemetry
UnpackControlSlowTelemetry.restype = size_t
UnpackControlSlowTelemetry.argtypes = [POINTER_T(ctypes.c_ubyte), size_t, POINTER_T(struct_c__SA_ControlSlowTelemetry)]
PACK_CONTROLTELEMETRY_SIZE = 11514
PackControlTelemetry = _libraries['control/_pack_control_telemetry.so'].PackControlTelemetry
PackControlTelemetry.restype = size_t
PackControlTelemetry.argtypes = [POINTER_T(struct_c__SA_ControlTelemetry), size_t, POINTER_T(ctypes.c_ubyte)]
UnpackControlTelemetry = _libraries['control/_pack_control_telemetry.so'].UnpackControlTelemetry
UnpackControlTelemetry.restype = size_t
UnpackControlTelemetry.argtypes = [POINTER_T(ctypes.c_ubyte), size_t, POINTER_T(struct_c__SA_ControlTelemetry)]
PACK_CROSSWINDTELEMETRY_SIZE = 380
PackCrosswindTelemetry = _libraries['control/_pack_control_telemetry.so'].PackCrosswindTelemetry
PackCrosswindTelemetry.restype = size_t
PackCrosswindTelemetry.argtypes = [POINTER_T(struct_c__SA_CrosswindTelemetry), size_t, POINTER_T(ctypes.c_ubyte)]
UnpackCrosswindTelemetry = _libraries['control/_pack_control_telemetry.so'].UnpackCrosswindTelemetry
UnpackCrosswindTelemetry.restype = size_t
UnpackCrosswindTelemetry.argtypes = [POINTER_T(ctypes.c_ubyte), size_t, POINTER_T(struct_c__SA_CrosswindTelemetry)]
PACK_ESTIMATORTELEMETRY_SIZE = 6597
PackEstimatorTelemetry = _libraries['control/_pack_control_telemetry.so'].PackEstimatorTelemetry
PackEstimatorTelemetry.restype = size_t
PackEstimatorTelemetry.argtypes = [POINTER_T(struct_c__SA_EstimatorTelemetry), size_t, POINTER_T(ctypes.c_ubyte)]
UnpackEstimatorTelemetry = _libraries['control/_pack_control_telemetry.so'].UnpackEstimatorTelemetry
UnpackEstimatorTelemetry.restype = size_t
UnpackEstimatorTelemetry.argtypes = [POINTER_T(ctypes.c_ubyte), size_t, POINTER_T(struct_c__SA_EstimatorTelemetry)]
PACK_HOVERTELEMETRY_SIZE = 600
PackHoverTelemetry = _libraries['control/_pack_control_telemetry.so'].PackHoverTelemetry
PackHoverTelemetry.restype = size_t
PackHoverTelemetry.argtypes = [POINTER_T(struct_c__SA_HoverTelemetry), size_t, POINTER_T(ctypes.c_ubyte)]
UnpackHoverTelemetry = _libraries['control/_pack_control_telemetry.so'].UnpackHoverTelemetry
UnpackHoverTelemetry.restype = size_t
UnpackHoverTelemetry.argtypes = [POINTER_T(ctypes.c_ubyte), size_t, POINTER_T(struct_c__SA_HoverTelemetry)]
PACK_MANUALTELEMETRY_SIZE = 18
PackManualTelemetry = _libraries['control/_pack_control_telemetry.so'].PackManualTelemetry
PackManualTelemetry.restype = size_t
PackManualTelemetry.argtypes = [POINTER_T(struct_c__SA_ManualTelemetry), size_t, POINTER_T(ctypes.c_ubyte)]
UnpackManualTelemetry = _libraries['control/_pack_control_telemetry.so'].UnpackManualTelemetry
UnpackManualTelemetry.restype = size_t
UnpackManualTelemetry.argtypes = [POINTER_T(ctypes.c_ubyte), size_t, POINTER_T(struct_c__SA_ManualTelemetry)]
PACK_PLANNERTELEMETRY_SIZE = 16
PackPlannerTelemetry = _libraries['control/_pack_control_telemetry.so'].PackPlannerTelemetry
PackPlannerTelemetry.restype = size_t
PackPlannerTelemetry.argtypes = [POINTER_T(struct_c__SA_PlannerTelemetry), size_t, POINTER_T(ctypes.c_ubyte)]
UnpackPlannerTelemetry = _libraries['control/_pack_control_telemetry.so'].UnpackPlannerTelemetry
UnpackPlannerTelemetry.restype = size_t
UnpackPlannerTelemetry.argtypes = [POINTER_T(ctypes.c_ubyte), size_t, POINTER_T(struct_c__SA_PlannerTelemetry)]
PACK_SYNCTELEMETRY_SIZE = 8
PackSyncTelemetry = _libraries['control/_pack_control_telemetry.so'].PackSyncTelemetry
PackSyncTelemetry.restype = size_t
PackSyncTelemetry.argtypes = [POINTER_T(struct_c__SA_SyncTelemetry), size_t, POINTER_T(ctypes.c_ubyte)]
UnpackSyncTelemetry = _libraries['control/_pack_control_telemetry.so'].UnpackSyncTelemetry
UnpackSyncTelemetry.restype = size_t
UnpackSyncTelemetry.argtypes = [POINTER_T(ctypes.c_ubyte), size_t, POINTER_T(struct_c__SA_SyncTelemetry)]
PACK_TRANSINTELEMETRY_SIZE = 240
PackTransInTelemetry = _libraries['control/_pack_control_telemetry.so'].PackTransInTelemetry
PackTransInTelemetry.restype = size_t
PackTransInTelemetry.argtypes = [POINTER_T(struct_c__SA_TransInTelemetry), size_t, POINTER_T(ctypes.c_ubyte)]
UnpackTransInTelemetry = _libraries['control/_pack_control_telemetry.so'].UnpackTransInTelemetry
UnpackTransInTelemetry.restype = size_t
UnpackTransInTelemetry.argtypes = [POINTER_T(ctypes.c_ubyte), size_t, POINTER_T(struct_c__SA_TransInTelemetry)]
_ASSERT_H = 1
__ASSERT_VOID_CAST = ['(', 'void', ')'] # macro
_ASSERT_H_DECLS = True
__assert_fail = _libraries['control/_pack_control_telemetry.so'].__assert_fail
...
__assert_perror_fail = _libraries['control/_pack_control_telemetry.so'].__assert_perror_fail
...
__assert = _libraries['control/_pack_control_telemetry.so'].__assert
...
strtok_r = _libraries['control/_pack_control_telemetry.so'].strtok_r
...
AioAnalogGetConfig = _libraries['control/_pack_control_telemetry.so'].AioAnalogGetConfig
...
AioIna219GetConfig = _libraries['control/_pack_control_telemetry.so'].AioIna219GetConfig
...
AioSi7021GetConfig = _libraries['control/_pack_control_telemetry.so'].AioSi7021GetConfig
...
BattAnalogGetConfig = _libraries['control/_pack_control_telemetry.so'].BattAnalogGetConfig
...
BattBq34z100GetConfig = _libraries['control/_pack_control_telemetry.so'].BattBq34z100GetConfig
...
BattLtc4151GetConfig = _libraries['control/_pack_control_telemetry.so'].BattLtc4151GetConfig
...
BattMcp342xGetConfig = _libraries['control/_pack_control_telemetry.so'].BattMcp342xGetConfig
...
CsAnalogGetConfig = _libraries['control/_pack_control_telemetry.so'].CsAnalogGetConfig
...
CsIna219GetConfig = _libraries['control/_pack_control_telemetry.so'].CsIna219GetConfig
...
CsSi7021GetConfig = _libraries['control/_pack_control_telemetry.so'].CsSi7021GetConfig
...
FcAnalogGetConfig = _libraries['control/_pack_control_telemetry.so'].FcAnalogGetConfig
...
FcIna219GetConfig = _libraries['control/_pack_control_telemetry.so'].FcIna219GetConfig
...
GroundIoAds7828GetConfig = _libraries['control/_pack_control_telemetry.so'].GroundIoAds7828GetConfig
...
GroundIoAnalogGetConfig = _libraries['control/_pack_control_telemetry.so'].GroundIoAnalogGetConfig
...
JoystickAnalogGetConfig = _libraries['control/_pack_control_telemetry.so'].JoystickAnalogGetConfig
...
JoystickIna219GetConfig = _libraries['control/_pack_control_telemetry.so'].JoystickIna219GetConfig
...
LoadcellAnalogGetConfig = _libraries['control/_pack_control_telemetry.so'].LoadcellAnalogGetConfig
...
MvlvAnalogGetConfig = _libraries['control/_pack_control_telemetry.so'].MvlvAnalogGetConfig
...
MvlvLtc2309GetConfig = _libraries['control/_pack_control_telemetry.so'].MvlvLtc2309GetConfig
...
MvlvMcp342xGetConfig = _libraries['control/_pack_control_telemetry.so'].MvlvMcp342xGetConfig
...
RecorderAnalogGetConfig = _libraries['control/_pack_control_telemetry.so'].RecorderAnalogGetConfig
...
RecorderIna219GetConfig = _libraries['control/_pack_control_telemetry.so'].RecorderIna219GetConfig
...
ServoAnalogGetConfig = _libraries['control/_pack_control_telemetry.so'].ServoAnalogGetConfig
...
ServoMcp342xGetConfig = _libraries['control/_pack_control_telemetry.so'].ServoMcp342xGetConfig
...
ServoMcp9800GetConfig = _libraries['control/_pack_control_telemetry.so'].ServoMcp9800GetConfig
...
ShortStackAnalogGetConfig = _libraries['control/_pack_control_telemetry.so'].ShortStackAnalogGetConfig
...
ShortStackMcp342xGetConfig = _libraries['control/_pack_control_telemetry.so'].ShortStackMcp342xGetConfig
...
MotorIna219GetConfig = _libraries['control/_pack_control_telemetry.so'].MotorIna219GetConfig
...
MotorSi7021GetConfig = _libraries['control/_pack_control_telemetry.so'].MotorSi7021GetConfig
...
BattLabelToBattAioNode = _libraries['control/_pack_control_telemetry.so'].BattLabelToBattAioNode
BattLabelToBattAioNode.restype = AioNode
BattLabelToBattAioNode.argtypes = [BattLabel]
BattAioNodeToBattLabel = _libraries['control/_pack_control_telemetry.so'].BattAioNodeToBattLabel
BattAioNodeToBattLabel.restype = BattLabel
BattAioNodeToBattLabel.argtypes = [AioNode]
CmdLabelToCmdAioNode = _libraries['control/_pack_control_telemetry.so'].CmdLabelToCmdAioNode
CmdLabelToCmdAioNode.restype = AioNode
CmdLabelToCmdAioNode.argtypes = [CmdLabel]
CmdAioNodeToCmdLabel = _libraries['control/_pack_control_telemetry.so'].CmdAioNodeToCmdLabel
CmdAioNodeToCmdLabel.restype = CmdLabel
CmdAioNodeToCmdLabel.argtypes = [AioNode]
ControllerLabelToControllerAioNode = _libraries['control/_pack_control_telemetry.so'].ControllerLabelToControllerAioNode
ControllerLabelToControllerAioNode.restype = AioNode
ControllerLabelToControllerAioNode.argtypes = [ControllerLabel]
ControllerAioNodeToControllerLabel = _libraries['control/_pack_control_telemetry.so'].ControllerAioNodeToControllerLabel
ControllerAioNodeToControllerLabel.restype = ControllerLabel
ControllerAioNodeToControllerLabel.argtypes = [AioNode]
CoreSwitchLabelToCoreSwitchAioNode = _libraries['control/_pack_control_telemetry.so'].CoreSwitchLabelToCoreSwitchAioNode
CoreSwitchLabelToCoreSwitchAioNode.restype = AioNode
CoreSwitchLabelToCoreSwitchAioNode.argtypes = [CoreSwitchLabel]
CoreSwitchAioNodeToCoreSwitchLabel = _libraries['control/_pack_control_telemetry.so'].CoreSwitchAioNodeToCoreSwitchLabel
CoreSwitchAioNodeToCoreSwitchLabel.restype = CoreSwitchLabel
CoreSwitchAioNodeToCoreSwitchLabel.argtypes = [AioNode]
DrumLabelToDrumAioNode = _libraries['control/_pack_control_telemetry.so'].DrumLabelToDrumAioNode
DrumLabelToDrumAioNode.restype = AioNode
DrumLabelToDrumAioNode.argtypes = [DrumLabel]
DrumAioNodeToDrumLabel = _libraries['control/_pack_control_telemetry.so'].DrumAioNodeToDrumLabel
DrumAioNodeToDrumLabel.restype = DrumLabel
DrumAioNodeToDrumLabel.argtypes = [AioNode]
DynoMotorLabelToDynoMotorAioNode = _libraries['control/_pack_control_telemetry.so'].DynoMotorLabelToDynoMotorAioNode
DynoMotorLabelToDynoMotorAioNode.restype = AioNode
DynoMotorLabelToDynoMotorAioNode.argtypes = [DynoMotorLabel]
DynoMotorAioNodeToDynoMotorLabel = _libraries['control/_pack_control_telemetry.so'].DynoMotorAioNodeToDynoMotorLabel
DynoMotorAioNodeToDynoMotorLabel.restype = DynoMotorLabel
DynoMotorAioNodeToDynoMotorLabel.argtypes = [AioNode]
EopLabelToEopAioNode = _libraries['control/_pack_control_telemetry.so'].EopLabelToEopAioNode
EopLabelToEopAioNode.restype = AioNode
EopLabelToEopAioNode.argtypes = [EopLabel]
EopAioNodeToEopLabel = _libraries['control/_pack_control_telemetry.so'].EopAioNodeToEopLabel
EopAioNodeToEopLabel.restype = EopLabel
EopAioNodeToEopLabel.argtypes = [AioNode]
FlightComputerLabelToFlightComputerAioNode = _libraries['control/_pack_control_telemetry.so'].FlightComputerLabelToFlightComputerAioNode
...
FlightComputerAioNodeToFlightComputerLabel = _libraries['control/_pack_control_telemetry.so'].FlightComputerAioNodeToFlightComputerLabel
...
GpsLabelToGpsAioNode = _libraries['control/_pack_control_telemetry.so'].GpsLabelToGpsAioNode
GpsLabelToGpsAioNode.restype = AioNode
GpsLabelToGpsAioNode.argtypes = [GpsLabel]
GpsAioNodeToGpsLabel = _libraries['control/_pack_control_telemetry.so'].GpsAioNodeToGpsLabel
GpsAioNodeToGpsLabel.restype = GpsLabel
GpsAioNodeToGpsLabel.argtypes = [AioNode]
GroundPowerQ7LabelToGroundPowerQ7AioNode = _libraries['control/_pack_control_telemetry.so'].GroundPowerQ7LabelToGroundPowerQ7AioNode
...
GroundPowerQ7AioNodeToGroundPowerQ7Label = _libraries['control/_pack_control_telemetry.so'].GroundPowerQ7AioNodeToGroundPowerQ7Label
...
GroundPowerTms570LabelToGroundPowerTms570AioNode = _libraries['control/_pack_control_telemetry.so'].GroundPowerTms570LabelToGroundPowerTms570AioNode
...
GroundPowerTms570AioNodeToGroundPowerTms570Label = _libraries['control/_pack_control_telemetry.so'].GroundPowerTms570AioNodeToGroundPowerTms570Label
...
GsEstimatorLabelToGsEstimatorAioNode = _libraries['control/_pack_control_telemetry.so'].GsEstimatorLabelToGsEstimatorAioNode
GsEstimatorLabelToGsEstimatorAioNode.restype = AioNode
GsEstimatorLabelToGsEstimatorAioNode.argtypes = [GsEstimatorLabel]
GsEstimatorAioNodeToGsEstimatorLabel = _libraries['control/_pack_control_telemetry.so'].GsEstimatorAioNodeToGsEstimatorLabel
GsEstimatorAioNodeToGsEstimatorLabel.restype = GsEstimatorLabel
GsEstimatorAioNodeToGsEstimatorLabel.argtypes = [AioNode]
JoystickLabelToJoystickAioNode = _libraries['control/_pack_control_telemetry.so'].JoystickLabelToJoystickAioNode
JoystickLabelToJoystickAioNode.restype = AioNode
JoystickLabelToJoystickAioNode.argtypes = [JoystickLabel]
JoystickAioNodeToJoystickLabel = _libraries['control/_pack_control_telemetry.so'].JoystickAioNodeToJoystickLabel
JoystickAioNodeToJoystickLabel.restype = JoystickLabel
JoystickAioNodeToJoystickLabel.argtypes = [AioNode]
LightLabelToLightAioNode = _libraries['control/_pack_control_telemetry.so'].LightLabelToLightAioNode
LightLabelToLightAioNode.restype = AioNode
LightLabelToLightAioNode.argtypes = [LightLabel]
LightAioNodeToLightLabel = _libraries['control/_pack_control_telemetry.so'].LightAioNodeToLightLabel
LightAioNodeToLightLabel.restype = LightLabel
LightAioNodeToLightLabel.argtypes = [AioNode]
LoadcellNodeLabelToLoadcellNodeAioNode = _libraries['control/_pack_control_telemetry.so'].LoadcellNodeLabelToLoadcellNodeAioNode
LoadcellNodeLabelToLoadcellNodeAioNode.restype = AioNode
LoadcellNodeLabelToLoadcellNodeAioNode.argtypes = [LoadcellNodeLabel]
LoadcellNodeAioNodeToLoadcellNodeLabel = _libraries['control/_pack_control_telemetry.so'].LoadcellNodeAioNodeToLoadcellNodeLabel
LoadcellNodeAioNodeToLoadcellNodeLabel.restype = LoadcellNodeLabel
LoadcellNodeAioNodeToLoadcellNodeLabel.argtypes = [AioNode]
MotorLabelToMotorAioNode = _libraries['control/_pack_control_telemetry.so'].MotorLabelToMotorAioNode
MotorLabelToMotorAioNode.restype = AioNode
MotorLabelToMotorAioNode.argtypes = [MotorLabel]
MotorAioNodeToMotorLabel = _libraries['control/_pack_control_telemetry.so'].MotorAioNodeToMotorLabel
MotorAioNodeToMotorLabel.restype = MotorLabel
MotorAioNodeToMotorLabel.argtypes = [AioNode]
MvlvLabelToMvlvAioNode = _libraries['control/_pack_control_telemetry.so'].MvlvLabelToMvlvAioNode
MvlvLabelToMvlvAioNode.restype = AioNode
MvlvLabelToMvlvAioNode.argtypes = [MvlvLabel]
MvlvAioNodeToMvlvLabel = _libraries['control/_pack_control_telemetry.so'].MvlvAioNodeToMvlvLabel
MvlvAioNodeToMvlvLabel.restype = MvlvLabel
MvlvAioNodeToMvlvLabel.argtypes = [AioNode]
OperatorLabelToOperatorAioNode = _libraries['control/_pack_control_telemetry.so'].OperatorLabelToOperatorAioNode
OperatorLabelToOperatorAioNode.restype = AioNode
OperatorLabelToOperatorAioNode.argtypes = [OperatorLabel]
OperatorAioNodeToOperatorLabel = _libraries['control/_pack_control_telemetry.so'].OperatorAioNodeToOperatorLabel
OperatorAioNodeToOperatorLabel.restype = OperatorLabel
OperatorAioNodeToOperatorLabel.argtypes = [AioNode]
PlatformLabelToPlatformAioNode = _libraries['control/_pack_control_telemetry.so'].PlatformLabelToPlatformAioNode
PlatformLabelToPlatformAioNode.restype = AioNode
PlatformLabelToPlatformAioNode.argtypes = [PlatformLabel]
PlatformAioNodeToPlatformLabel = _libraries['control/_pack_control_telemetry.so'].PlatformAioNodeToPlatformLabel
PlatformAioNodeToPlatformLabel.restype = PlatformLabel
PlatformAioNodeToPlatformLabel.argtypes = [AioNode]
PlcGs02LabelToPlcGs02AioNode = _libraries['control/_pack_control_telemetry.so'].PlcGs02LabelToPlcGs02AioNode
PlcGs02LabelToPlcGs02AioNode.restype = AioNode
PlcGs02LabelToPlcGs02AioNode.argtypes = [PlcGs02Label]
PlcGs02AioNodeToPlcGs02Label = _libraries['control/_pack_control_telemetry.so'].PlcGs02AioNodeToPlcGs02Label
PlcGs02AioNodeToPlcGs02Label.restype = PlcGs02Label
PlcGs02AioNodeToPlcGs02Label.argtypes = [AioNode]
PlcTophatLabelToPlcTophatAioNode = _libraries['control/_pack_control_telemetry.so'].PlcTophatLabelToPlcTophatAioNode
PlcTophatLabelToPlcTophatAioNode.restype = AioNode
PlcTophatLabelToPlcTophatAioNode.argtypes = [PlcTophatLabel]
PlcTophatAioNodeToPlcTophatLabel = _libraries['control/_pack_control_telemetry.so'].PlcTophatAioNodeToPlcTophatLabel
PlcTophatAioNodeToPlcTophatLabel.restype = PlcTophatLabel
PlcTophatAioNodeToPlcTophatLabel.argtypes = [AioNode]
RecorderQ7LabelToRecorderQ7AioNode = _libraries['control/_pack_control_telemetry.so'].RecorderQ7LabelToRecorderQ7AioNode
RecorderQ7LabelToRecorderQ7AioNode.restype = AioNode
RecorderQ7LabelToRecorderQ7AioNode.argtypes = [RecorderQ7Label]
RecorderQ7AioNodeToRecorderQ7Label = _libraries['control/_pack_control_telemetry.so'].RecorderQ7AioNodeToRecorderQ7Label
RecorderQ7AioNodeToRecorderQ7Label.restype = RecorderQ7Label
RecorderQ7AioNodeToRecorderQ7Label.argtypes = [AioNode]
RecorderTms570LabelToRecorderTms570AioNode = _libraries['control/_pack_control_telemetry.so'].RecorderTms570LabelToRecorderTms570AioNode
...
RecorderTms570AioNodeToRecorderTms570Label = _libraries['control/_pack_control_telemetry.so'].RecorderTms570AioNodeToRecorderTms570Label
...
ServoLabelToServoAioNode = _libraries['control/_pack_control_telemetry.so'].ServoLabelToServoAioNode
ServoLabelToServoAioNode.restype = AioNode
ServoLabelToServoAioNode.argtypes = [ServoLabel]
ServoAioNodeToServoLabel = _libraries['control/_pack_control_telemetry.so'].ServoAioNodeToServoLabel
ServoAioNodeToServoLabel.restype = ServoLabel
ServoAioNodeToServoLabel.argtypes = [AioNode]
ShortStackLabelToShortStackAioNode = _libraries['control/_pack_control_telemetry.so'].ShortStackLabelToShortStackAioNode
ShortStackLabelToShortStackAioNode.restype = AioNode
ShortStackLabelToShortStackAioNode.argtypes = [ShortStackLabel]
ShortStackAioNodeToShortStackLabel = _libraries['control/_pack_control_telemetry.so'].ShortStackAioNodeToShortStackLabel
ShortStackAioNodeToShortStackLabel.restype = ShortStackLabel
ShortStackAioNodeToShortStackLabel.argtypes = [AioNode]
SimulatedJoystickLabelToSimulatedJoystickAioNode = _libraries['control/_pack_control_telemetry.so'].SimulatedJoystickLabelToSimulatedJoystickAioNode
...
SimulatedJoystickAioNodeToSimulatedJoystickLabel = _libraries['control/_pack_control_telemetry.so'].SimulatedJoystickAioNodeToSimulatedJoystickLabel
...
SimulatorLabelToSimulatorAioNode = _libraries['control/_pack_control_telemetry.so'].SimulatorLabelToSimulatorAioNode
SimulatorLabelToSimulatorAioNode.restype = AioNode
SimulatorLabelToSimulatorAioNode.argtypes = [SimulatorLabel]
SimulatorAioNodeToSimulatorLabel = _libraries['control/_pack_control_telemetry.so'].SimulatorAioNodeToSimulatorLabel
SimulatorAioNodeToSimulatorLabel.restype = SimulatorLabel
SimulatorAioNodeToSimulatorLabel.argtypes = [AioNode]
TelemetrySnapshotLabelToTelemetrySnapshotAioNode = _libraries['control/_pack_control_telemetry.so'].TelemetrySnapshotLabelToTelemetrySnapshotAioNode
...
TelemetrySnapshotAioNodeToTelemetrySnapshotLabel = _libraries['control/_pack_control_telemetry.so'].TelemetrySnapshotAioNodeToTelemetrySnapshotLabel
...
TorqueCellLabelToTorqueCellAioNode = _libraries['control/_pack_control_telemetry.so'].TorqueCellLabelToTorqueCellAioNode
TorqueCellLabelToTorqueCellAioNode.restype = AioNode
TorqueCellLabelToTorqueCellAioNode.argtypes = [TorqueCellLabel]
TorqueCellAioNodeToTorqueCellLabel = _libraries['control/_pack_control_telemetry.so'].TorqueCellAioNodeToTorqueCellLabel
TorqueCellAioNodeToTorqueCellLabel.restype = TorqueCellLabel
TorqueCellAioNodeToTorqueCellLabel.argtypes = [AioNode]
UwbLabelToUwbAioNode = _libraries['control/_pack_control_telemetry.so'].UwbLabelToUwbAioNode
UwbLabelToUwbAioNode.restype = AioNode
UwbLabelToUwbAioNode.argtypes = [UwbLabel]
UwbAioNodeToUwbLabel = _libraries['control/_pack_control_telemetry.so'].UwbAioNodeToUwbLabel
UwbAioNodeToUwbLabel.restype = UwbLabel
UwbAioNodeToUwbLabel.argtypes = [AioNode]
VisualizerLabelToVisualizerAioNode = _libraries['control/_pack_control_telemetry.so'].VisualizerLabelToVisualizerAioNode
VisualizerLabelToVisualizerAioNode.restype = AioNode
VisualizerLabelToVisualizerAioNode.argtypes = [VisualizerLabel]
VisualizerAioNodeToVisualizerLabel = _libraries['control/_pack_control_telemetry.so'].VisualizerAioNodeToVisualizerLabel
VisualizerAioNodeToVisualizerLabel.restype = VisualizerLabel
VisualizerAioNodeToVisualizerLabel.argtypes = [AioNode]
BattLabelToString = _libraries['control/_pack_control_telemetry.so'].BattLabelToString
BattLabelToString.restype = POINTER_T(ctypes.c_char)
BattLabelToString.argtypes = [BattLabel]
CmdLabelToString = _libraries['control/_pack_control_telemetry.so'].CmdLabelToString
CmdLabelToString.restype = POINTER_T(ctypes.c_char)
CmdLabelToString.argtypes = [CmdLabel]
ControllerLabelToString = _libraries['control/_pack_control_telemetry.so'].ControllerLabelToString
ControllerLabelToString.restype = POINTER_T(ctypes.c_char)
ControllerLabelToString.argtypes = [ControllerLabel]
CoreSwitchLabelToString = _libraries['control/_pack_control_telemetry.so'].CoreSwitchLabelToString
CoreSwitchLabelToString.restype = POINTER_T(ctypes.c_char)
CoreSwitchLabelToString.argtypes = [CoreSwitchLabel]
DrumLabelToString = _libraries['control/_pack_control_telemetry.so'].DrumLabelToString
DrumLabelToString.restype = POINTER_T(ctypes.c_char)
DrumLabelToString.argtypes = [DrumLabel]
DynoMotorLabelToString = _libraries['control/_pack_control_telemetry.so'].DynoMotorLabelToString
DynoMotorLabelToString.restype = POINTER_T(ctypes.c_char)
DynoMotorLabelToString.argtypes = [DynoMotorLabel]
EopLabelToString = _libraries['control/_pack_control_telemetry.so'].EopLabelToString
EopLabelToString.restype = POINTER_T(ctypes.c_char)
EopLabelToString.argtypes = [EopLabel]
FlightComputerLabelToString = _libraries['control/_pack_control_telemetry.so'].FlightComputerLabelToString
FlightComputerLabelToString.restype = POINTER_T(ctypes.c_char)
FlightComputerLabelToString.argtypes = [FlightComputerLabel]
GpsLabelToString = _libraries['control/_pack_control_telemetry.so'].GpsLabelToString
GpsLabelToString.restype = POINTER_T(ctypes.c_char)
GpsLabelToString.argtypes = [GpsLabel]
GroundPowerQ7LabelToString = _libraries['control/_pack_control_telemetry.so'].GroundPowerQ7LabelToString
GroundPowerQ7LabelToString.restype = POINTER_T(ctypes.c_char)
GroundPowerQ7LabelToString.argtypes = [GroundPowerQ7Label]
GroundPowerTms570LabelToString = _libraries['control/_pack_control_telemetry.so'].GroundPowerTms570LabelToString
...
SimulatorLabelToString = _libraries['control/_pack_control_telemetry.so'].SimulatorLabelToString
SimulatorLabelToString.restype = POINTER_T(ctypes.c_char)
SimulatorLabelToString.argtypes = [SimulatorLabel]
TelemetrySnapshotLabelToString = _libraries['control/_pack_control_telemetry.so'].TelemetrySnapshotLabelToString
...
TorqueCellLabelToString = _libraries['control/_pack_control_telemetry.so'].TorqueCellLabelToString
TorqueCellLabelToString.restype = POINTER_T(ctypes.c_char)
TorqueCellLabelToString.argtypes = [TorqueCellLabel]
UwbLabelToString = _libraries['control/_pack_control_telemetry.so'].UwbLabelToString
UwbLabelToString.restype = POINTER_T(ctypes.c_char)
UwbLabelToString.argtypes = [UwbLabel]
VisualizerLabelToString = _libraries['control/_pack_control_telemetry.so'].VisualizerLabelToString
...
AioNodeToString = _libraries['control/_pack_control_telemetry.so'].AioNodeToString
AioNodeToString.restype = POINTER_T(ctypes.c_char)
AioNodeToString.argtypes = [AioNode]
AioNodeToShortString = _libraries['control/_pack_control_telemetry.so'].AioNodeToShortString
AioNodeToShortString.restype = POINTER_T(ctypes.c_char)
AioNodeToShortString.argtypes = [AioNode]
StringToAioNode = _libraries['control/_pack_control_telemetry.so'].StringToAioNode
StringToAioNode.restype = AioNode
StringToAioNode.argtypes = [POINTER_T(ctypes.c_char)]
IsQ7Node = _libraries['control/_pack_control_telemetry.so'].IsQ7Node
IsQ7Node.restype = ctypes.c_bool
IsQ7Node.argtypes = [AioNode]
IsTms570Node = _libraries['control/_pack_control_telemetry.so'].IsTms570Node
IsTms570Node.restype = ctypes.c_bool
IsTms570Node.argtypes = [AioNode]
IsValidNode = _libraries['control/_pack_control_telemetry.so'].IsValidNode
IsValidNode.restype = ctypes.c_bool
IsValidNode.argtypes = [AioNode]
IsRemoteCommandNode = _libraries['control/_pack_control_telemetry.so'].IsRemoteCommandNode
IsRemoteCommandNode.restype = ctypes.c_bool
IsRemoteCommandNode.argtypes = [AioNode]
IsWingNode = _libraries['control/_pack_control_telemetry.so'].IsWingNode
IsWingNode.restype = ctypes.c_bool
IsWingNode.argtypes = [AioNode]
IsGroundStationNode = _libraries['control/_pack_control_telemetry.so'].IsGroundStationNode
IsGroundStationNode.restype = ctypes.c_bool
IsGroundStationNode.argtypes = [AioNode]
IsTestFixtureNode = _libraries['control/_pack_control_telemetry.so'].IsTestFixtureNode
IsTestFixtureNode.restype = ctypes.c_bool
IsTestFixtureNode.argtypes = [AioNode]
IsBattNode = _libraries['control/_pack_control_telemetry.so'].IsBattNode
IsBattNode.restype = ctypes.c_bool
IsBattNode.argtypes = [AioNode]
IsCmdNode = _libraries['control/_pack_control_telemetry.so'].IsCmdNode
IsCmdNode.restype = ctypes.c_bool
IsCmdNode.argtypes = [AioNode]
IsControllerNode = _libraries['control/_pack_control_telemetry.so'].IsControllerNode
IsControllerNode.restype = ctypes.c_bool
IsControllerNode.argtypes = [AioNode]
IsCoreSwitchNode = _libraries['control/_pack_control_telemetry.so'].IsCoreSwitchNode
IsCoreSwitchNode.restype = ctypes.c_bool
IsCoreSwitchNode.argtypes = [AioNode]
IsDrumNode = _libraries['control/_pack_control_telemetry.so'].IsDrumNode
IsDrumNode.restype = ctypes.c_bool
IsDrumNode.argtypes = [AioNode]
IsDynoMotorNode = _libraries['control/_pack_control_telemetry.so'].IsDynoMotorNode
IsDynoMotorNode.restype = ctypes.c_bool
IsDynoMotorNode.argtypes = [AioNode]
IsEopNode = _libraries['control/_pack_control_telemetry.so'].IsEopNode
IsEopNode.restype = ctypes.c_bool
IsEopNode.argtypes = [AioNode]
IsFlightComputerNode = _libraries['control/_pack_control_telemetry.so'].IsFlightComputerNode
IsFlightComputerNode.restype = ctypes.c_bool
IsFlightComputerNode.argtypes = [AioNode]
IsGpsNode = _libraries['control/_pack_control_telemetry.so'].IsGpsNode
IsGpsNode.restype = ctypes.c_bool
IsGpsNode.argtypes = [AioNode]
IsGroundPowerQ7Node = _libraries['control/_pack_control_telemetry.so'].IsGroundPowerQ7Node
IsGroundPowerQ7Node.restype = ctypes.c_bool
IsGroundPowerQ7Node.argtypes = [AioNode]
IsGroundPowerTms570Node = _libraries['control/_pack_control_telemetry.so'].IsGroundPowerTms570Node
IsGroundPowerTms570Node.restype = ctypes.c_bool
IsGroundPowerTms570Node.argtypes = [AioNode]
IsGsEstimatorNode = _libraries['control/_pack_control_telemetry.so'].IsGsEstimatorNode
IsGsEstimatorNode.restype = ctypes.c_bool
IsGsEstimatorNode.argtypes = [AioNode]
IsJoystickNode = _libraries['control/_pack_control_telemetry.so'].IsJoystickNode
IsJoystickNode.restype = ctypes.c_bool
IsJoystickNode.argtypes = [AioNode]
IsLightNode = _libraries['control/_pack_control_telemetry.so'].IsLightNode
IsLightNode.restype = ctypes.c_bool
IsLightNode.argtypes = [AioNode]
IsLoadcellNodeNode = _libraries['control/_pack_control_telemetry.so'].IsLoadcellNodeNode
IsLoadcellNodeNode.restype = ctypes.c_bool
IsLoadcellNodeNode.argtypes = [AioNode]
IsMotorNode = _libraries['control/_pack_control_telemetry.so'].IsMotorNode
IsMotorNode.restype = ctypes.c_bool
IsMotorNode.argtypes = [AioNode]
IsMvlvNode = _libraries['control/_pack_control_telemetry.so'].IsMvlvNode
IsMvlvNode.restype = ctypes.c_bool
IsMvlvNode.argtypes = [AioNode]
IsOperatorNode = _libraries['control/_pack_control_telemetry.so'].IsOperatorNode
IsOperatorNode.restype = ctypes.c_bool
IsOperatorNode.argtypes = [AioNode]
IsPlatformNode = _libraries['control/_pack_control_telemetry.so'].IsPlatformNode
IsPlatformNode.restype = ctypes.c_bool
IsPlatformNode.argtypes = [AioNode]
IsPlcGs02Node = _libraries['control/_pack_control_telemetry.so'].IsPlcGs02Node
IsPlcGs02Node.restype = ctypes.c_bool
IsPlcGs02Node.argtypes = [AioNode]
IsPlcTophatNode = _libraries['control/_pack_control_telemetry.so'].IsPlcTophatNode
IsPlcTophatNode.restype = ctypes.c_bool
IsPlcTophatNode.argtypes = [AioNode]
IsRecorderQ7Node = _libraries['control/_pack_control_telemetry.so'].IsRecorderQ7Node
IsRecorderQ7Node.restype = ctypes.c_bool
IsRecorderQ7Node.argtypes = [AioNode]
IsRecorderTms570Node = _libraries['control/_pack_control_telemetry.so'].IsRecorderTms570Node
IsRecorderTms570Node.restype = ctypes.c_bool
IsRecorderTms570Node.argtypes = [AioNode]
IsServoNode = _libraries['control/_pack_control_telemetry.so'].IsServoNode
IsServoNode.restype = ctypes.c_bool
IsServoNode.argtypes = [AioNode]
IsShortStackNode = _libraries['control/_pack_control_telemetry.so'].IsShortStackNode
IsShortStackNode.restype = ctypes.c_bool
IsShortStackNode.argtypes = [AioNode]
IsSimulatedJoystickNode = _libraries['control/_pack_control_telemetry.so'].IsSimulatedJoystickNode
IsSimulatedJoystickNode.restype = ctypes.c_bool
IsSimulatedJoystickNode.argtypes = [AioNode]
IsSimulatorNode = _libraries['control/_pack_control_telemetry.so'].IsSimulatorNode
IsSimulatorNode.restype = ctypes.c_bool
IsSimulatorNode.argtypes = [AioNode]
IsTelemetrySnapshotNode = _libraries['control/_pack_control_telemetry.so'].IsTelemetrySnapshotNode
IsTelemetrySnapshotNode.restype = ctypes.c_bool
IsTelemetrySnapshotNode.argtypes = [AioNode]
IsTorqueCellNode = _libraries['control/_pack_control_telemetry.so'].IsTorqueCellNode
IsTorqueCellNode.restype = ctypes.c_bool
IsTorqueCellNode.argtypes = [AioNode]
IsUnknownNode = _libraries['control/_pack_control_telemetry.so'].IsUnknownNode
IsUnknownNode.restype = ctypes.c_bool
IsUnknownNode.argtypes = [AioNode]
IsUwbNode = _libraries['control/_pack_control_telemetry.so'].IsUwbNode
IsUwbNode.restype = ctypes.c_bool
IsUwbNode.argtypes = [AioNode]
IsVisualizerNode = _libraries['control/_pack_control_telemetry.so'].IsVisualizerNode
IsVisualizerNode.restype = ctypes.c_bool
IsVisualizerNode.argtypes = [AioNode]
AVIONICS_NETWORK_EOP_MESSAGE_TYPE_H_ = True
EopMessageTypeToString = _libraries['control/_pack_control_telemetry.so'].EopMessageTypeToString
EopMessageTypeToString.restype = POINTER_T(ctypes.c_char)
EopMessageTypeToString.argtypes = [EopMessageType]
EopMessageTypeToShortString = _libraries['control/_pack_control_telemetry.so'].EopMessageTypeToShortString
EopMessageTypeToShortString.restype = POINTER_T(ctypes.c_char)
EopMessageTypeToShortString.argtypes = [EopMessageType]
IsValidEopMessageType = _libraries['control/_pack_control_telemetry.so'].IsValidEopMessageType
IsValidEopMessageType.restype = ctypes.c_bool
IsValidEopMessageType.argtypes = [EopMessageType]
StringToEopMessageType = _libraries['control/_pack_control_telemetry.so'].StringToEopMessageType
...
MessageTypeToString = _libraries['control/_pack_control_telemetry.so'].MessageTypeToString
MessageTypeToString.restype = POINTER_T(ctypes.c_char)
MessageTypeToString.argtypes = [MessageType]
MessageTypeToShortString = _libraries['control/_pack_control_telemetry.so'].MessageTypeToShortString
MessageTypeToShortString.restype = POINTER_T(ctypes.c_char)
MessageTypeToShortString.argtypes = [MessageType]
IsValidMessageType = _libraries['control/_pack_control_telemetry.so'].IsValidMessageType
IsValidMessageType.restype = ctypes.c_bool
IsValidMessageType.argtypes = [MessageType]
StringToMessageType = _libraries['control/_pack_control_telemetry.so'].StringToMessageType
...
WinchMessageTypeToString = _libraries['control/_pack_control_telemetry.so'].WinchMessageTypeToString
WinchMessageTypeToString.restype = POINTER_T(ctypes.c_char)
WinchMessageTypeToString.argtypes = [WinchMessageType]
WinchMessageTypeToShortString = _libraries['control/_pack_control_telemetry.so'].WinchMessageTypeToShortString
WinchMessageTypeToShortString.restype = POINTER_T(ctypes.c_char)
WinchMessageTypeToShortString.argtypes = [WinchMessageType]
IsValidWinchMessageType = _libraries['control/_pack_control_telemetry.so'].IsValidWinchMessageType
IsValidWinchMessageType.restype = ctypes.c_bool
IsValidWinchMessageType.argtypes = [WinchMessageType]
StringToWinchMessageType = _libraries['control/_pack_control_telemetry.so'].StringToWinchMessageType
...
__all__ = \
    ...
    'DynoMotorGetParamMessage', 'Vec3Norm',
    'kAioNodeTelemetrySnapshot', 'kNumMotorIna219Monitors',
    'CrosswindPathType', 'kLtc4151MonitorFlagUnderVoltage',
    ...
    'AioMonitorWarning', 'LoadbankStateAckParamMessage',
    'struct_c__SA_TetherJoystick', 'kNovAtelSolutionTypeWideInt',
    'kNovAtelSolutionStatusCovTrace', 'kLtc6804SelfTest1',
    'kAttitudeNoiseBiasGRwZ', 'struct_c__SA_MotorCalibrationMessage',
    'kAttitudeNoiseBiasGRwX', 'struct_c__SA_LoadcellData', 'VecAdd',
    'HoverPositionState', 'kAioIna219Monitor1v2', 'NovAtelLogHeading',
    'kDynoMotorPto', 'kActuatorStateTest', 'kServoAnalogInputVServo',
    ...
    'kMessageTypeControlTelemetry', 'PackControlTelemetry',
    'kPlcErrorFlagDetwistServoABad',
    ...
    'UnpackHoverTelemetry', 'MotorSpeedLimit',
    'struct_c__SA_TestExecuteMessage',
    ...
    'c__EA_ActuatorHitlLevel', 'kGillDataIdMetPakMeanWindVelocity',
    ...
    'kRecorderIna219Monitor5v', 'TetherBatteryTemp',
    'AioModuleMonitorData', 'kSeptentrioIdGpsAlm',
    'kAioMonitorStatusGtiDetect', 'kGainStateFull',
    'struct_c__SA_FaultDetectionLevelwindEleParams', 'uint_fast16_t',
    'IsSimulatedJoystickNode', 'LevelWindSensorBusInternal',
    'uint_fast32_t', 'struct_c__SA_ProfilerOutput',
    'c__EA_GsMotorStatusFlag', 'GsAxisErrorFlag',
    'kSeptentrioPvtModePrecisePointPositioning',
    ...
    'kFaultDetectionGsgSignalEle', 'kGillDataIdWindmasterUvw',
    'kGroundPowerQ7A', 'ServoAckParamMessage',
    'kMotorAngleCalModeNoise', 'GetWingGpsVelFault',
    'DrumLabelToString', 'kJoystickChannelLabelForceSigned',
    'NovAtelCompassMessage', 'EopMessageTypeToIpAddress',
    'kServoErrorR22OverVoltage', 'kMvlvMonitorErrorEnclosureAir',
    'kSubsysWingGpsCrosswindPos', 'HoverPathParams',
    'c__EA_CrosswindInnerAirspeeds', 'Mcp342xChannel',
    'RateLimitVec3', 'struct_c__SA_RecorderMonitorData',
    'kAioNodeShortStack', 'Ltc4151BusRawToMillivolts', 'wchar_t',
    ...
    'kNumAioIna219Monitors', 'kBattAnalogInputForceSigned',
    'struct_c__SA_HoverPathState', 'c__EA_MvlvMcp342xMonitor',
    'kServoAnalogVoltage5v', 'AnalogMonitor', 'AioSi7021GetConfig',
    'kNumPositionNoises', 'IpAddressToUint32',
    'c__EA_HoverPayOutGate', 'kNumLoadcellSensors',
    ...
    'c__EA_GsWarningFlag', 'kLtc6804ForceSigned', 'kPropVersionRev2',
    'kLtc6804StatChItmp', 'kNovAtelPortModeCdgps',
    'kFaultTypeDisabled', 'kIna219Adc32Samples',
    'kNovAtelPortCom2All', 'kNumAioAnalogVoltages',
    'c__EA_NovAtelSolutionStatus', 'MotorIsrLogMessage',
    'Vec2LinComb3', 'kSimulatedJoystickLabelForceSigned',
    'StringToWinchMessageType', 'GitHash', 'kNumFlightModes',
    'kSubsysImuBGyro', 'kBattMonitorErrorHeatPlate1',
    'kBattMonitorErrorHeatPlate2', 'kSubsysWingGpsPortVel',
    'EstimatorNavKiteState', 'Ina219ShuntRawToAmps',
    'kHoverFullLengthGateForceSigned', 'kLoadcellHardwareRevAa',
    'struct_c__SA_TetherGsGpsPosition', 'kGsAxisStateOff', 'GpsUtc',
    'AngleToDcm', 'kSeptentrioIdGeoCorrections',
    'kMessageTypeNovAtelObservations', 'struct_c__SA_HoverWinchState',
    'kNumDrums', 'kRecorderAnalogVoltageForceSigned',
    'c__EA_GsPerchEncodersError', 'struct_c__SA_ServoGetParamMessage',
    'AioIna219Monitor', 'kFcMonitorErrorQ7ThermalTrip',
    'kFlightModeHoverDescend', 'kTemperatureInfoFlagCpuZone0Valid',
    ...
    'c__EA_GillWindmasterField', 'QuatRotate',
    ...
    'c__EA_PlcOpenState', 'RecorderIna219Monitor', 'JoinVec3Arr',
    'kNumHoverTransformGsDownGates', 'kSubsysWingGpsStarVel',
    'QuatConj', 'struct_c__SA_CrosswindCurvatureState',
    'kRotationOrderYxy', 'kShortStackAnalogInput5v',
    'struct_c__SA_BoundedKalman1dParams', 'c__EA_TetherMvlvTemp',
    'kLtc6804Dcto4min', 'kTetherPlatformFlagLevelwindElevationFault',
    ...
    'QuatMod', 'struct_c__SA_Q7SlowStatusMessage',
    'kNumMvlvAnalogVoltages', 'struct_c__SA_TestFailureMessage',
    'JoystickMonitorStatusMessage', 'PitotSensor',
    'kGsStatusFlagWinchJogNeg', 'kSeptentrioIdQualityInd',
    'MaxUint64', 'kMvlvAnalogInputVExt',
    ...
    'UnpackControlSlowTelemetry', 'kServoAnalogVoltageVServo',
    ...
    'WingModel', 'PackTransInTelemetry',
    ...
    'GsAxisState', 'MvlvMonitorStatus', 'kCsHardwareForceSize',
    'kVec2Ones', 'c__EA_TetherWeatherFlag', 'c__EA_ControlOption',
    ...
    'kHoverDescendGateSpeed', 'HitlConfiguration',
    'kMvlvAnalogInputVLvOr',
    ...
    'GroundvionicsSequenceNumbers', 'kNumCsAnalogInputs',
    ...
    'kSeptentrioIdReceiverTime', 'HoverTensionParams',
    ...
    'kGsPerchEncodersErrorDrumPosition', 'UnpackCrosswindTelemetry',
    ...
    'c__EA_GsStatusFlag', 'kGroundStationModelTopHat',
    'AioAnalogVoltage', 'kDynoMotorSto',
    'struct_c__SA_HoverAltitudeParams', 'kDynoMotorSti', 'IsDrumNode',
    'LoopDirection', 'kLtc4151MonitorFlagOverVoltage',
    'kAttitudeStateBiasGZ', 'struct_c__SA_CrosswindTelemetry',
    ...
    'GsPerchEncodersWarning', 'kMessageTypeSeptentrioSolution',
    'CsMonitorStatus', 'GsEstimatorLabel', 'MatArrZero',
    'IsSaturated', 'kGillMetPakFieldDirection',
    'GroundPowerTms570Label', 'kNumFaultDetectionImuSignals',
    'c__EA_ShortStackGpioOutputPin', 'NovAtelMessageId',
    ...
    'RecorderMonitorWarning', 'DetwistControlBus',
    'AvionicsFaultsGsCompassState', 'kMessageTypeServoStatus',
    'Ina219MonitorFlag', 'struct_c__SA_CrosswindCurvatureParams',
    ...
    'Ina219Mode', 'CrosswindHoverTransOutGateToString',
    'c__EA_GroundIoHardware', 'kGillMetPakStatusOk',
    'SeptentrioPvtModeBits', 'kSubsysPitotSensorHighSpeedAlpha',
    'kWingSerial07Crosswind', 'kMessageTypeServoClearErrorLog',
    'kFcIna219Monitor12v',
    'struct_c__SA_FaultDetectionPerchAziParams', 'DecawaveMessage',
    'PackHoverTelemetry', 'kSi7021CommandWriteHeaterControlReg',
    'DynoMotorLabelToString', 'GroundStationMode',
    'kGsPerchEncodersErrorLevelwindElevation', 'kCsIna219Monitor12v',
    'kNumWingModels', 'TetherMotorTemp', 'kNumTetherMergeTrunks',
    'kRecorderQ7LabelForceSigned',
    ...
    'kBattStateCommandConnect', 'BattHardware', 'Ltc6804AuxCh',
    ...
    'kSubsysServoA2', 'kTransInGateMinDynamicPressure',
    'PlcOpenStateInvalid', 'IsValidNode',
    ...
    'kNumUwbs', 'kSeptentrioIdComment', 'TetherPlatform',
    ...
    'kWingImuLabelForceSigned', 'EstimatorWeatherParams', 'MatRank',
    ...
    'kGillWindmasterStatusNvmChecksumFailed', 'GsImuLabel',
    ...
    'kControllerBitA', 'MatMult', 'PackManualTelemetry',
    'NovAtelLogBestXyz', 'kNumEstimatorPosMeasurements',
    'CrossfadeMat3', 'kSeptentrioIdGeoDegrFactors',
    ...
    'kMotorSbo', 'EstimatorPositionGpsEstimate',
    ...
    'struct_c__SA_CrosswindSpoilerExperiment',
    ...
    'kGroundIoAds7828MonitorCan3Power', 'kAioMonitorWarning3v3',
    'kServoA2', 'struct_c__SA_ServoPairedStatusMessage',
    'kShortStackGpioOutputPinForceTripB0',
    'kShortStackGpioOutputPinForceTripB3',
    'kShortStackGpioOutputPinForceTripB2', 'UnpackControlTelemetry',
    'FaultDetectionWindSensorParams', 'kAioNodeGpsBaseStation',
    'kPlcInfoFlagEstopped', 'kMessageTypeGroundEstimateSim',
    'kMvlvAnalogInputVLvPri',
    ...
    'kShortStackAnalogVoltageBlock0', 'PackControlDebugMessage',
    ...
    'DrumLabelToDrumAioNode', 'PeakDetectorVec3',
    'kNumNovAtelRxStatuses', 'ShortStackLabel',
    ...
    'PlcGs02LabelToString', 'InvertEncoderCal',
    'kMessageTypeGroundPowerCommand', 'kMessageTypeMotorDebug',
    'ControllerSyncMessage', 'kFlightModePilotHover',
    'WinchProximityFlag', 'HoverDescendGate',
    ...
    'kGillMetPakStatusWindNvmChecksumFailed',
    ...
    'CrosswindLateralStates', 'kMessageTypeSimSensor',
    'c__EA_LoadcellHardware', 'uint_least64_t',
    'kSi7021ResolutionRh11BitTemp11Bit', 'Bq34z100MonitorFlag',
    'struct_c__SA_HoverTetherElevationState',
    ...
    'NovAtelPortMode', 'kServoAnalogVoltage12v',
    'VisualizerLabelToVisualizerAioNode',
    'kBattMonitorStatusCharging',
    'kGsPerchEncodersErrorLevelwindWrist', 'IsValidWinchMessageType',
    'EstimatorPositionBaroEstimate', 'kMvlvAnalogVoltageIHall',
    'c__EA_HoverAccelGate', 'GetImuFaults', 'Mcp342xGain',
    'c__EA_PortErrorFlag', 'Ina219BuildConfig',
    'struct_c__SA_ManualState', 'HoverReelInGate',
    'kArs308StatusNvmWriteSuccess', 'kPlcErrorFlagDetwistCmdJump',
    'kMessageTypeShortStackStacking', 'CrosswindNormalGate',
    'struct_c__SA_HoverAltitudeState', 'kAttitudeNoiseGyroX',
    'struct_c__SA_TestStartMessage', 'kNumGroundIoAnalogVoltages',
    'c__EA_TetherCommsLink', 'kNumFlightPlans', 'kLtc6804StatChVa',
    ...
    'AnalogFlag', 'kSubsysGsGpsVel', 'struct_c__SA_EstimatorNavState',
    'c__EA_RecorderQ7Label', 'kCrosswindLateralStateRollRate',
    'kMotorThermalChannelCapacitor', 'c__EA_GsSystemMode',
    'UnpackManualTelemetry', 'kParamSectionConfig',
    'kSubsysWingGpsPortPos', 'FlightStatus', 'c__EA_MotorSpeedLimit',
    'struct_c__SA_GroundEstimatorState',
    ...
    'PackControlSlowTelemetry', 'kAioNodeServoR2',
    'GroundEstimateMessage', 'kAioNodeServoR1', 'kSubsysServoR1',
    ...
    'kDetwistCommandPopError', 'MvlvLabelToMvlvAioNode',
    'EstimatorPositionGroundState', 'FcAnalogVoltage',
    'kIna219Adc9Bit', 'PackPlannerTelemetry',
    ...
    'kMessageTypeServoSetState', 'kMessageTypeGroundStationStatus',
    'kCsMonitorStatusHiltDetect', 'NovAtelSolutionStatus',
    'Q7SlowStatusContext', 'kSeptentrioIdAttEuler', 'IsDynoMotorNode',
    ...
    'PackSyncTelemetry', 'MatMatLeftDivide', 'kPitotSensorLowSpeed',
    ...
    'kLoadcellAnalogInputEepromWp', 'kArs308StatusNvmReadSuccess',
    'kSubsysGsCompass', 'kFcIna219Monitor12vInst', 'MaxArrayInt64',
    ...
    'kPlcInfoFlagDetwistReady', 'kServoStatusArmed',
    ...
    'struct_c__SA_Ltc2309MonitorDevice', 'kSubsysGsgAEle',
    'c__EA_AioMonitorStatus', 'EstimatorPositionCorrection',
    'kGsSystemModeManual', 'kSubsysServoE1',
    'struct_c__SA_FaultDetectionParams', 'kGroundStationModeManual',
    'kNumHoverFullLengthGates', 'c__EA_LoadcellAnalogInput',
    'BattPairedStatusMessage', 'c__EA_GsDrumEncodersWarning',
    'TetherCommsLink', 'VecAxpy',
    ...
    'kLtc6804CellCh5And11', 'kShortStackAnalogVoltageBlock1',
    'kMotorThermalChannelControllerAir',
    ...
    'c__EA_BattHardware', 'PlcTophatLabelToPlcTophatAioNode',
    'ServoR22Input', 'HasFault', 'kRecorderMonitorWarning3v3Sata',
    ...
    'UnpackSyncTelemetry', 'struct_c__SA_PlatformSensorsMessage',
    ...
    'kSubsysLoadcellSensorStarboard0', 'kShortStackMonitorWarning5v',
    'SimulatedJoystickLabelToString', 'kSeptentrioIdPosCart',
    'EopLabel', 'kNovAtelSolutionStatusSolComputed',
    'IsSimulatorNode', 'struct_c__SA_ApparentWindEstimate',
    ...
    'GroundEstimatorInput', 'Ltc6804CellIndex', 'CsSi7021GetConfig',
    ...
    'struct_c__SA_PitotSetStateMessage', 'PackEstimatorTelemetry',
    'kBattAnalogInputIChg', 'kIna219Adc2Samples',
    'struct_c__SA_AvionicsFaultsLoadcellsState',
    ...
    'Ads7828PowerConverter', 'UnpackPlannerTelemetry',
    ...
    'kTetherGpsSolutionStatusRtkFloat', 'HoverTransformGsDownGate',
    'kFlightModeHoverTransformGsUp', 'c__EA_BattLtc4151Monitor',
    'strcpy', 'kCoreSwitchLabelForceSigned', 'kSubsysWingGpsStarPos',
    ...
    'DiffLpf2', 'ShortStackHardware', 'BattBq34z100Monitor',
    'kTetherMotorTempNacelleAir', 'kTetherBatteryTempHeatPlate2',
    'c__EA_EstimatorPosMeasType', 'kTetherBatteryTempHeatPlate1',
    'kMessageTypeShortStackCommand', 'kNovAtelPortCom1All',
    'Ltc6804Dcto', 'c__EA_GsAxisWarningFlag',
    ...
    'SeptentrioPvtErrorToString', 'kServoE2', 'kVec3Ones',
    ...
    'GroundStationCoolant', 'kSubsysLoadcellSensorPort1',
    'PoseTransform', 'QuatInv', 'ApparentWindEstimate',
    'ServoAnalogInput', 'struct_c__SA_HPUControlBusExternal',
    ...
    'kServoErrorHallFailure', 'kNovAtelSolutionStatusPending',
    'LoadcellMonitorWarning', 'kMessageTypeNovAtelSolution',
    'kLoadcellMonitorWarning5v', 'kNovAtelSolutionTypeOmnistarXp',
    'EstimatorAttitudeCorrections', 'kBattAnalogInputLvB',
    '__assert_fail', 'c__EA_MahonyVecType',
    ...
    'UnpackControlDebugMessage', 'kNumTransInLateralStates',
    'kCoordinateSystemGsg', 'GroundIoAds7828GetConfig',
    ...
    'Si7021RelHumidityRawToPercent', 'bcmp', 'strxfrm_l',
    'GroundvionicsFaultsState', 'GsgParams', 'HoldData',
    'Si7021Config', 'c__EA_FaultDetectionPitotSignalType',
    'kSeptentrioIdPosLocal', 'struct_c__SA_HoverTelemetry',
    ...
    'kSeptentrioPvtErrorDopTooLarge',
    'kServoAnalogVoltageForceSigned', 'kSeptentrioIdVelCovCartesian',
    ...
    'struct_c__SA_EstimatorTetherAnchorParams', 'JoystickLabel',
    ...
    'kArs308TargetAnglePoint', 'kGroundStationModelForceSigned',
    'kAnalogTypeLogicHigh', 'kMotorLightTypeForceSigned',
    'kAioAnalogInputPortRssi3', 'c__EA_WingGpsReceiverLabel',
    'BatteryStatusMessage', 'kAioAnalogVoltagePortRssi0',
    'kWingSerial04Hover', 'Gs02DrumAngles', 'PlcOpenStateStandstill',
    'Ltc4151OutputRaw', 'TetherMvlvStatus',
    'kArs308TargetTypeStationary', 'OperatorLabel',
    'kHoverAscendGateForceSigned', 'kGsSystemModeReel',
    'kGillMetPakStatusWindPowerFailure', 'kSeptentrioPvtErrorNone',
    'struct_c__SA_ControlSlowTelemetry',
    'struct_c__SA_EopEthCounters', 'c__EA_HoverDescendGate',
    'kSeptentrioIdAttCovEuler', 'PackCrosswindTelemetry',
    ...
    'LightState', 'kLtc6804Dcto60min', 'UnpackTransInTelemetry',
    ...
    'kCoreSwitchGsB', 'struct_c__SA_HitlConfiguration',
    'GroundStationPoseEstimate', 'kNovAtelSolutionStatusTestDist',
    'kLoadcellNodePortA', 'AxesControlBusExternal',
    'CsMonitorWarning', 'kMotorMonitorWarning12v', 'PlannerTelemetry',
    '__strtok_r', 'kServoMonitorWarning5v', 'TetherForceSph',
    'kGainStateEStopped', 'c__EA_Ads7828Select', 'HoverAccelGate',
    'Mcp9800Config', 'kControllerLabelForceSigned',
    'c__EA_LoopDirection', 'NovAtelLogRtkXyz', 'MvlvLabelToString',
    ...
    'kMvlvMonitorErrorNone', 'kSeptentrioIdGalAlm', 'Ina219OutputRaw',
    'MaxArrayUint32', 'kLtc2309SelectDiffCh2Ch3', 'kBridlePort',
    'kMotorSti', 'c__EA_LightType',
    ...
    'kPositionStateVelY', 'kAioNodeEopGsB',
    'MessageTypeToShortString', 'kSeptentrioIdGeoFastCorrDegr',
    'kAioNodeDrumSensorsB', 'kAioNodeDrumSensorsA', 'SphToCart',
    ...
    'EopMessageTypeToShortString', 'c__EA_CsAnalogInput',
    'JoystickParams', 'FaultMask', 'kSubsysWindSensor',
    'BattBq34z100GetConfig', 'FaultMaskFromInt32',
    'EstimatorNavState', 'struct_c__SA_NovAtelLogRxConfig',
    'TetherNodeStatus', 'struct_c__SA_CircularAveragingBuffer',
    ...
    'GroundPowerQ7Label', 'struct_c__SA_GpsEphemeris', 'Sigmoid',
    'SmallControlTelemetryMessage', 'LightTiming',
...
H2PY_HEADER_FILE = 'control/pack_control_telemetry.h'
