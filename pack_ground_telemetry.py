...
_libraries = {}
#_libraries['control/_pack_ground_telemetry.so'] = ctypes.CDLL(os.path.join(makani.HOME, 'control/_pack_ground_telemetry.so'))
_libraries['control/_pack_ground_telemetry.so'] = ctypes.CDLL('./lib/_pack_ground_telemetry.so')
...
AioMessageTypeToIpAddress = _libraries['control/_pack_ground_telemetry.so'].AioMessageTypeToIpAddress
AioMessageTypeToIpAddress.restype = IpAddress
AioMessageTypeToIpAddress.argtypes = [MessageType]
AioMessageTypeToEthernetAddress = _libraries['control/_pack_ground_telemetry.so'].AioMessageTypeToEthernetAddress
...
WinchMessageTypeToIpAddress = _libraries['control/_pack_ground_telemetry.so'].WinchMessageTypeToIpAddress
...
EopMessageTypeToIpAddress = _libraries['control/_pack_ground_telemetry.so'].EopMessageTypeToIpAddress
EopMessageTypeToIpAddress.restype = IpAddress
EopMessageTypeToIpAddress.argtypes = [EopMessageType]
WinchMessageTypeToEthernetAddress = _libraries['control/_pack_ground_telemetry.so'].WinchMessageTypeToEthernetAddress
WinchMessageTypeToEthernetAddress.restype = EthernetAddress
WinchMessageTypeToEthernetAddress.argtypes = [WinchMessageType]
EopMessageTypeToEthernetAddress = _libraries['control/_pack_ground_telemetry.so'].EopMessageTypeToEthernetAddress
EopMessageTypeToEthernetAddress.restype = EthernetAddress
EopMessageTypeToEthernetAddress.argtypes = [EopMessageType]
IpAddressToEthernetAddress = _libraries['control/_pack_ground_telemetry.so'].IpAddressToEthernetAddress
IpAddressToEthernetAddress.restype = EthernetAddress
IpAddressToEthernetAddress.argtypes = [IpAddress]
uint32_t = ctypes.c_uint32
IpAddressToUint32 = _libraries['control/_pack_ground_telemetry.so'].IpAddressToUint32
IpAddressToUint32.restype = uint32_t
IpAddressToUint32.argtypes = [IpAddress]
Uint32ToIpAddress = _libraries['control/_pack_ground_telemetry.so'].Uint32ToIpAddress
...
NovAtelSolutionTypeToString = _libraries['control/_pack_ground_telemetry.so'].NovAtelSolutionTypeToString
NovAtelSolutionTypeToString.restype = POINTER_T(ctypes.c_char)
NovAtelSolutionTypeToString.argtypes = [NovAtelSolutionType]
NovAtelSolutionStatusToString = _libraries['control/_pack_ground_telemetry.so'].NovAtelSolutionStatusToString
...
SeptentrioPvtModeToString = _libraries['control/_pack_ground_telemetry.so'].SeptentrioPvtModeToString
SeptentrioPvtModeToString.restype = POINTER_T(ctypes.c_char)
SeptentrioPvtModeToString.argtypes = [SeptentrioPvtMode]
SeptentrioPvtErrorToString = _libraries['control/_pack_ground_telemetry.so'].SeptentrioPvtErrorToString
...
Ads7828BuildCommand = _libraries['control/_pack_ground_telemetry.so'].Ads7828BuildCommand
...
Bq34z100BusRawToVolts = _libraries['control/_pack_ground_telemetry.so'].Bq34z100BusRawToVolts
Bq34z100BusRawToVolts.restype = ctypes.c_float
Bq34z100BusRawToVolts.argtypes = [uint16_t, ctypes.c_float]
Bq34z100Convert = _libraries['control/_pack_ground_telemetry.so'].Bq34z100Convert
...
Ina219BuildConfig = _libraries['control/_pack_ground_telemetry.so'].Ina219BuildConfig
...
Ina219BusRawToMillivolts = _libraries['control/_pack_ground_telemetry.so'].Ina219BusRawToMillivolts
Ina219BusRawToMillivolts.restype = int32_t
Ina219BusRawToMillivolts.argtypes = [uint16_t]
int16_t = ctypes.c_int16
Ina219ShuntRawToAmps = _libraries['control/_pack_ground_telemetry.so'].Ina219ShuntRawToAmps
Ina219ShuntRawToAmps.restype = ctypes.c_float
Ina219ShuntRawToAmps.argtypes = [int16_t, ctypes.c_float]
Ina219Convert = _libraries['control/_pack_ground_telemetry.so'].Ina219Convert
...
Ltc2309BuildCommand = _libraries['control/_pack_ground_telemetry.so'].Ltc2309BuildCommand
...
Ltc4151BusRawToMillivolts = _libraries['control/_pack_ground_telemetry.so'].Ltc4151BusRawToMillivolts
Ltc4151BusRawToMillivolts.restype = int32_t
Ltc4151BusRawToMillivolts.argtypes = [uint16_t]
Ltc4151ShuntRawToAmps = _libraries['control/_pack_ground_telemetry.so'].Ltc4151ShuntRawToAmps
Ltc4151ShuntRawToAmps.restype = ctypes.c_float
Ltc4151ShuntRawToAmps.argtypes = [int16_t, ctypes.c_float]
Ltc4151Convert = _libraries['control/_pack_ground_telemetry.so'].Ltc4151Convert
...
Mcp342xBuildConfig = _libraries['control/_pack_ground_telemetry.so'].Mcp342xBuildConfig
...
Mcp9800BuildConfig = _libraries['control/_pack_ground_telemetry.so'].Mcp9800BuildConfig
Mcp9800BuildConfig.restype = uint8_t
Mcp9800BuildConfig.argtypes = [Mcp9800Resolution]
Mcp9800TempRawToC = _libraries['control/_pack_ground_telemetry.so'].Mcp9800TempRawToC
...
Si7021BuildUserReg1 = _libraries['control/_pack_ground_telemetry.so'].Si7021BuildUserReg1
Si7021BuildUserReg1.restype = uint8_t
Si7021BuildUserReg1.argtypes = [Si7021Resolution]
Si7021RelHumidityRawToPercent = _libraries['control/_pack_ground_telemetry.so'].Si7021RelHumidityRawToPercent
Si7021RelHumidityRawToPercent.restype = ctypes.c_float
Si7021RelHumidityRawToPercent.argtypes = [uint16_t]
Si7021TempRawToC = _libraries['control/_pack_ground_telemetry.so'].Si7021TempRawToC
Si7021TempRawToC.restype = ctypes.c_float
Si7021TempRawToC.argtypes = [uint16_t]
Si7021Convert = _libraries['control/_pack_ground_telemetry.so'].Si7021Convert
...
Hpf = _libraries['control/_pack_ground_telemetry.so'].Hpf
...
Diff = _libraries['control/_pack_ground_telemetry.so'].Diff
Diff.restype = ctypes.c_double
Diff.argtypes = [ctypes.c_double, ctypes.c_double, POINTER_T(ctypes.c_double)]
DiffVec3 = _libraries['control/_pack_ground_telemetry.so'].DiffVec3
...
DiffCircular = _libraries['control/_pack_ground_telemetry.so'].DiffCircular
...
RateLimit = _libraries['control/_pack_ground_telemetry.so'].RateLimit
...
RateLimitInt32 = _libraries['control/_pack_ground_telemetry.so'].RateLimitInt32
RateLimitInt32.restype = int32_t
RateLimitInt32.argtypes = [int32_t, int32_t, int32_t, ctypes.c_double, POINTER_T(ctypes.c_int32)]
RateLimitVec3 = _libraries['control/_pack_ground_telemetry.so'].RateLimitVec3
...
RateLimitCircular = _libraries['control/_pack_ground_telemetry.so'].RateLimitCircular
...
Filter = _libraries['control/_pack_ground_telemetry.so'].Filter
...
FilterCircularBuffer = _libraries['control/_pack_ground_telemetry.so'].FilterCircularBuffer
...
HoldMax = _libraries['control/_pack_ground_telemetry.so'].HoldMax
...
LatchOn = _libraries['control/_pack_ground_telemetry.so'].LatchOn
LatchOn.restype = ctypes.c_bool
LatchOn.argtypes = [int32_t, ctypes.c_double, ctypes.c_double, POINTER_T(ctypes.c_int32)]
Zoh = _libraries['control/_pack_ground_telemetry.so'].Zoh
...
Pid = _libraries['control/_pack_ground_telemetry.so'].Pid
...
PidAntiWindup = _libraries['control/_pack_ground_telemetry.so'].PidAntiWindup
...
CrossfadePidParams = _libraries['control/_pack_ground_telemetry.so'].CrossfadePidParams
...
SecondOrderFilterCoeff = _libraries['control/_pack_ground_telemetry.so'].SecondOrderFilterCoeff
...
Lpf2Init = _libraries['control/_pack_ground_telemetry.so'].Lpf2Init
Lpf2Init.restype = None
Lpf2Init.argtypes = [ctypes.c_double, ctypes.c_double, ctypes.c_double, ctypes.c_double, ctypes.c_double * 0]
Lpf2Vec3Init = _libraries['control/_pack_ground_telemetry.so'].Lpf2Vec3Init
...
Lpf2 = _libraries['control/_pack_ground_telemetry.so'].Lpf2
...
Hpf2 = _libraries['control/_pack_ground_telemetry.so'].Hpf2
...
BandPass2 = _libraries['control/_pack_ground_telemetry.so'].BandPass2
...
DiffLpf2 = _libraries['control/_pack_ground_telemetry.so'].DiffLpf2
...
Lpf2Vec3 = _libraries['control/_pack_ground_telemetry.so'].Lpf2Vec3
...
Hpf2Vec3 = _libraries['control/_pack_ground_telemetry.so'].Hpf2Vec3
...
BandPass2Vec3 = _libraries['control/_pack_ground_telemetry.so'].BandPass2Vec3
...
DiffLpf2Vec3 = _libraries['control/_pack_ground_telemetry.so'].DiffLpf2Vec3
...
PeakDetector = _libraries['control/_pack_ground_telemetry.so'].PeakDetector
...
PeakDetectorVec3 = _libraries['control/_pack_ground_telemetry.so'].PeakDetectorVec3
...
InitCircularAveragingBuffer = _libraries['control/_pack_ground_telemetry.so'].InitCircularAveragingBuffer
...
UpdateCircularAveragingBuffer = _libraries['control/_pack_ground_telemetry.so'].UpdateCircularAveragingBuffer
...
DcmToAngle = _libraries['control/_pack_ground_telemetry.so'].DcmToAngle
...
AngleToDcm = _libraries['control/_pack_ground_telemetry.so'].AngleToDcm
...
CartToSph = _libraries['control/_pack_ground_telemetry.so'].CartToSph
...
SphToCart = _libraries['control/_pack_ground_telemetry.so'].SphToCart
...
CartToCyl = _libraries['control/_pack_ground_telemetry.so'].CartToCyl
...
CylToCart = _libraries['control/_pack_ground_telemetry.so'].CylToCart
...
PoseTransform = _libraries['control/_pack_ground_telemetry.so'].PoseTransform
...
InversePoseTransform = _libraries['control/_pack_ground_telemetry.so'].InversePoseTransform
...
Vec3ToAxisAngle = _libraries['control/_pack_ground_telemetry.so'].Vec3ToAxisAngle
...
ProjectVec3ToPlane = _libraries['control/_pack_ground_telemetry.so'].ProjectVec3ToPlane
...
Vec2ToAngle = _libraries['control/_pack_ground_telemetry.so'].Vec2ToAngle
Vec2ToAngle.restype = ctypes.c_double
Vec2ToAngle.argtypes = [POINTER_T(struct_Vec2), POINTER_T(struct_Vec2)]
IntersectLinePlane = _libraries['control/_pack_ground_telemetry.so'].IntersectLinePlane
...
SignedAngleBetweenVectors = _libraries['control/_pack_ground_telemetry.so'].SignedAngleBetweenVectors
...
BoundedKalman1d = _libraries['control/_pack_ground_telemetry.so'].BoundedKalman1d
...
BoundedKalman1dEstimator = _libraries['control/_pack_ground_telemetry.so'].BoundedKalman1dEstimator
...
UdKalmanExtractUd = _libraries['control/_pack_ground_telemetry.so'].UdKalmanExtractUd
...
UdKalmanStoreUpperTri = _libraries['control/_pack_ground_telemetry.so'].UdKalmanStoreUpperTri
...
UdKalmanCalcWeightVectors = _libraries['control/_pack_ground_telemetry.so'].UdKalmanCalcWeightVectors
...
UdKalmanCalcGain = _libraries['control/_pack_ground_telemetry.so'].UdKalmanCalcGain
...
UdKalmanMeasurementUpdate = _libraries['control/_pack_ground_telemetry.so'].UdKalmanMeasurementUpdate
...
UdKalmanTimeUpdate = _libraries['control/_pack_ground_telemetry.so'].UdKalmanTimeUpdate
...
UdKalmanExtractCovariances = _libraries['control/_pack_ground_telemetry.so'].UdKalmanExtractCovariances
UdKalmanExtractCovariances.restype = None
UdKalmanExtractCovariances.argtypes = [ctypes.c_double * 0, POINTER_T(struct_c__SA_Vec)]
UdKalmanTransitionMatrixMultiply = _libraries['control/_pack_ground_telemetry.so'].UdKalmanTransitionMatrixMultiply
...
VecAdd = _libraries['control/_pack_ground_telemetry.so'].VecAdd
...
VecAdd3 = _libraries['control/_pack_ground_telemetry.so'].VecAdd3
...
VecSub = _libraries['control/_pack_ground_telemetry.so'].VecSub
...
VecLinComb = _libraries['control/_pack_ground_telemetry.so'].VecLinComb
...
VecLinComb3 = _libraries['control/_pack_ground_telemetry.so'].VecLinComb3
...
VecMult = _libraries['control/_pack_ground_telemetry.so'].VecMult
...
VecSlice = _libraries['control/_pack_ground_telemetry.so'].VecSlice
...
VecSliceSet = _libraries['control/_pack_ground_telemetry.so'].VecSliceSet
...
MatScale = _libraries['control/_pack_ground_telemetry.so'].MatScale
...
MatI = _libraries['control/_pack_ground_telemetry.so'].MatI
MatI.restype = POINTER_T(struct_c__SA_Mat)
MatI.argtypes = [int32_t, POINTER_T(struct_c__SA_Mat)]
MatMult = _libraries['control/_pack_ground_telemetry.so'].MatMult
...
MatVecGenMult = _libraries['control/_pack_ground_telemetry.so'].MatVecGenMult
...
MatGenMult = _libraries['control/_pack_ground_telemetry.so'].MatGenMult
...
MatMult3 = _libraries['control/_pack_ground_telemetry.so'].MatMult3
...
MatVecMult = _libraries['control/_pack_ground_telemetry.so'].MatVecMult
...
MatTransVecMult = _libraries['control/_pack_ground_telemetry.so'].MatTransVecMult
...
MatTrans = _libraries['control/_pack_ground_telemetry.so'].MatTrans
MatTrans.restype = POINTER_T(struct_c__SA_Mat)
MatTrans.argtypes = [POINTER_T(struct_c__SA_Mat), POINTER_T(struct_c__SA_Mat)]
MatAdd = _libraries['control/_pack_ground_telemetry.so'].MatAdd
...
MatSub = _libraries['control/_pack_ground_telemetry.so'].MatSub
...
MatQrDecomp = _libraries['control/_pack_ground_telemetry.so'].MatQrDecomp
...
MatThinSvDecomp = _libraries['control/_pack_ground_telemetry.so'].MatThinSvDecomp
...
MatRank = _libraries['control/_pack_ground_telemetry.so'].MatRank
MatRank.restype = int32_t
MatRank.argtypes = [POINTER_T(struct_c__SA_Mat), ctypes.c_double]
MatVecLeftDivide = _libraries['control/_pack_ground_telemetry.so'].MatVecLeftDivide
...
MatVecRightDivide = _libraries['control/_pack_ground_telemetry.so'].MatVecRightDivide
...
MatMatLeftDivide = _libraries['control/_pack_ground_telemetry.so'].MatMatLeftDivide
...
MatMatRightDivide = _libraries['control/_pack_ground_telemetry.so'].MatMatRightDivide
...
MatIsUpperTriangular = _libraries['control/_pack_ground_telemetry.so'].MatIsUpperTriangular
MatIsUpperTriangular.restype = ctypes.c_bool
MatIsUpperTriangular.argtypes = [POINTER_T(struct_c__SA_Mat)]
MatIsLowerTriangular = _libraries['control/_pack_ground_telemetry.so'].MatIsLowerTriangular
MatIsLowerTriangular.restype = ctypes.c_bool
MatIsLowerTriangular.argtypes = [POINTER_T(struct_c__SA_Mat)]
MatHasNonnegDiag = _libraries['control/_pack_ground_telemetry.so'].MatHasNonnegDiag
MatHasNonnegDiag.restype = ctypes.c_bool
MatHasNonnegDiag.argtypes = [POINTER_T(struct_c__SA_Mat)]
MatSqrtSum = _libraries['control/_pack_ground_telemetry.so'].MatSqrtSum
...
MatMatBackSub = _libraries['control/_pack_ground_telemetry.so'].MatMatBackSub
...
MatMatForwardSub = _libraries['control/_pack_ground_telemetry.so'].MatMatForwardSub
...
MatVecBackSub = _libraries['control/_pack_ground_telemetry.so'].MatVecBackSub
...
MatVecForwardSub = _libraries['control/_pack_ground_telemetry.so'].MatVecForwardSub
...
MatSlice = _libraries['control/_pack_ground_telemetry.so'].MatSlice
...
MatArrMult = _libraries['control/_pack_ground_telemetry.so'].MatArrMult
...
MatArrGemv = _libraries['control/_pack_ground_telemetry.so'].MatArrGemv
...
MatArrGemm = _libraries['control/_pack_ground_telemetry.so'].MatArrGemm
...
MatArrIsUpperTriangular = _libraries['control/_pack_ground_telemetry.so'].MatArrIsUpperTriangular
MatArrIsUpperTriangular.restype = ctypes.c_bool
MatArrIsUpperTriangular.argtypes = [POINTER_T(ctypes.c_double), int32_t, int32_t]
MatArrIsLowerTriangular = _libraries['control/_pack_ground_telemetry.so'].MatArrIsLowerTriangular
MatArrIsLowerTriangular.restype = ctypes.c_bool
MatArrIsLowerTriangular.argtypes = [POINTER_T(ctypes.c_double), int32_t, int32_t]
MatArrBackSub = _libraries['control/_pack_ground_telemetry.so'].MatArrBackSub
...
MatArrForwardSub = _libraries['control/_pack_ground_telemetry.so'].MatArrForwardSub
...
Mat2 = struct_Mat2
kMat2Zero = (struct_Mat2).in_dll(_libraries['control/_pack_ground_telemetry.so'], 'kMat2Zero')
kMat2Identity = (struct_Mat2).in_dll(_libraries['control/_pack_ground_telemetry.so'], 'kMat2Identity')
MAT2_DISP = ['(', 'm', ')', 'printf', '(', '"%s:%u %s = [%.12f, %.12f; %.12f, %.12f]\\n"', ',', '__FILE__', ',', '__LINE__', ',', '#', 'm', ',', '(', 'm', ')', '.', 'd', '[', '0', ']', '[', '0', ']', ',', '(', 'm', ')', '.', 'd', '[', '0', ']', '[', '1', ']', ',', '(', 'm', ')', '.', 'd', '[', '1', ']', '[', '0', ']', ',', '(', 'm', ')', '.', 'd', '[', '1', ']', '[', '1', ']', ')', ';'] # macro
Mat2Scale = _libraries['control/_pack_ground_telemetry.so'].Mat2Scale
Mat2Scale.restype = POINTER_T(struct_Mat2)
Mat2Scale.argtypes = [POINTER_T(struct_Mat2), ctypes.c_double, POINTER_T(struct_Mat2)]
Mat2Vec2Axpby = _libraries['control/_pack_ground_telemetry.so'].Mat2Vec2Axpby
...
Mat2Abpyc = _libraries['control/_pack_ground_telemetry.so'].Mat2Abpyc
...
Mat2Add = _libraries['control/_pack_ground_telemetry.so'].Mat2Add
...
Mat2Mult = _libraries['control/_pack_ground_telemetry.so'].Mat2Mult
...
Mat2Vec2Mult = _libraries['control/_pack_ground_telemetry.so'].Mat2Vec2Mult
...
Mat2TransVec2Mult = _libraries['control/_pack_ground_telemetry.so'].Mat2TransVec2Mult
...
Mat2Det = _libraries['control/_pack_ground_telemetry.so'].Mat2Det
Mat2Det.restype = ctypes.c_double
Mat2Det.argtypes = [POINTER_T(struct_Mat2)]
Mat2Inv = _libraries['control/_pack_ground_telemetry.so'].Mat2Inv
Mat2Inv.restype = POINTER_T(struct_Mat2)
Mat2Inv.argtypes = [POINTER_T(struct_Mat2), POINTER_T(struct_Mat2)]
Mat2Vec2LeftDivide = _libraries['control/_pack_ground_telemetry.so'].Mat2Vec2LeftDivide
...
Mat2Trace = _libraries['control/_pack_ground_telemetry.so'].Mat2Trace
Mat2Trace.restype = ctypes.c_double
Mat2Trace.argtypes = [POINTER_T(struct_Mat2)]
Mat2Diag = _libraries['control/_pack_ground_telemetry.so'].Mat2Diag
Mat2Diag.restype = POINTER_T(struct_Vec2)
Mat2Diag.argtypes = [POINTER_T(struct_Mat2), POINTER_T(struct_Vec2)]
Mat2Trans = _libraries['control/_pack_ground_telemetry.so'].Mat2Trans
...
kMat3Zero = (struct_Mat3).in_dll(_libraries['control/_pack_ground_telemetry.so'], 'kMat3Zero')
kMat3Identity = (struct_Mat3).in_dll(_libraries['control/_pack_ground_telemetry.so'], 'kMat3Identity')
...
Mat3Scale = _libraries['control/_pack_ground_telemetry.so'].Mat3Scale
Mat3Scale.restype = POINTER_T(struct_Mat3)
Mat3Scale.argtypes = [POINTER_T(struct_Mat3), ctypes.c_double, POINTER_T(struct_Mat3)]
Mat3Vec3Axpby = _libraries['control/_pack_ground_telemetry.so'].Mat3Vec3Axpby
...
Mat3Abpyc = _libraries['control/_pack_ground_telemetry.so'].Mat3Abpyc
...
Mat3Add = _libraries['control/_pack_ground_telemetry.so'].Mat3Add
...
Mat3Mult = _libraries['control/_pack_ground_telemetry.so'].Mat3Mult
...
Mat3Vec3Mult = _libraries['control/_pack_ground_telemetry.so'].Mat3Vec3Mult
...
Mat3TransVec3Mult = _libraries['control/_pack_ground_telemetry.so'].Mat3TransVec3Mult
...
Mat3Mat3Mult = _libraries['control/_pack_ground_telemetry.so'].Mat3Mat3Mult
...
Mat3Det = _libraries['control/_pack_ground_telemetry.so'].Mat3Det
Mat3Det.restype = ctypes.c_double
Mat3Det.argtypes = [POINTER_T(struct_Mat3)]
Mat3Inv = _libraries['control/_pack_ground_telemetry.so'].Mat3Inv
Mat3Inv.restype = POINTER_T(struct_Mat3)
Mat3Inv.argtypes = [POINTER_T(struct_Mat3), POINTER_T(struct_Mat3)]
Mat3Vec3LeftDivide = _libraries['control/_pack_ground_telemetry.so'].Mat3Vec3LeftDivide
...
QuatLinComb3 = _libraries['control/_pack_ground_telemetry.so'].QuatLinComb3
...
QuatDivide = _libraries['control/_pack_ground_telemetry.so'].QuatDivide
...
AngleToQuat = _libraries['control/_pack_ground_telemetry.so'].AngleToQuat
...
QuatToMrp = _libraries['control/_pack_ground_telemetry.so'].QuatToMrp
QuatToMrp.restype = None
QuatToMrp.argtypes = [POINTER_T(struct_Quat), POINTER_T(struct_Vec3)]
MrpToQuat = _libraries['control/_pack_ground_telemetry.so'].MrpToQuat
MrpToQuat.restype = None
MrpToQuat.argtypes = [POINTER_T(struct_Vec3), POINTER_T(struct_Quat)]
Vec3Vec3ToDcm = _libraries['control/_pack_ground_telemetry.so'].Vec3Vec3ToDcm
...
MinInt32 = _libraries['control/_pack_ground_telemetry.so'].MinInt32
MinInt32.restype = int32_t
MinInt32.argtypes = [int32_t, int32_t]
MaxInt32 = _libraries['control/_pack_ground_telemetry.so'].MaxInt32
MaxInt32.restype = int32_t
MaxInt32.argtypes = [int32_t, int32_t]
MinUint32 = _libraries['control/_pack_ground_telemetry.so'].MinUint32
MinUint32.restype = uint32_t
MinUint32.argtypes = [uint32_t, uint32_t]
MaxUint32 = _libraries['control/_pack_ground_telemetry.so'].MaxUint32
MaxUint32.restype = uint32_t
MaxUint32.argtypes = [uint32_t, uint32_t]
int64_t = ctypes.c_int64
MinInt64 = _libraries['control/_pack_ground_telemetry.so'].MinInt64
MinInt64.restype = int64_t
MinInt64.argtypes = [int64_t, int64_t]
MaxInt64 = _libraries['control/_pack_ground_telemetry.so'].MaxInt64
MaxInt64.restype = int64_t
MaxInt64.argtypes = [int64_t, int64_t]
uint64_t = ctypes.c_uint64
MinUint64 = _libraries['control/_pack_ground_telemetry.so'].MinUint64
MinUint64.restype = uint64_t
MinUint64.argtypes = [uint64_t, uint64_t]
MaxUint64 = _libraries['control/_pack_ground_telemetry.so'].MaxUint64
MaxUint64.restype = uint64_t
MaxUint64.argtypes = [uint64_t, uint64_t]
MaxUnsignedValue = _libraries['control/_pack_ground_telemetry.so'].MaxUnsignedValue
MaxUnsignedValue.restype = uint32_t
MaxUnsignedValue.argtypes = [int32_t]
MinSignedValue = _libraries['control/_pack_ground_telemetry.so'].MinSignedValue
MinSignedValue.restype = int32_t
MinSignedValue.argtypes = [int32_t]
MaxSignedValue = _libraries['control/_pack_ground_telemetry.so'].MaxSignedValue
MaxSignedValue.restype = int32_t
MaxSignedValue.argtypes = [int32_t]
Sign = _libraries['control/_pack_ground_telemetry.so'].Sign
Sign.restype = int32_t
Sign.argtypes = [ctypes.c_double]
SignInt32 = _libraries['control/_pack_ground_telemetry.so'].SignInt32
SignInt32.restype = int32_t
SignInt32.argtypes = [int32_t]
IsApproximatelyEqual = _libraries['control/_pack_ground_telemetry.so'].IsApproximatelyEqual
IsApproximatelyEqual.restype = ctypes.c_bool
IsApproximatelyEqual.argtypes = [ctypes.c_double, ctypes.c_double]
IsApproximatelyEqualVec3 = _libraries['control/_pack_ground_telemetry.so'].IsApproximatelyEqualVec3
...
SaturateVec3 = _libraries['control/_pack_ground_telemetry.so'].SaturateVec3
...
SaturateVec3ByScalar = _libraries['control/_pack_ground_telemetry.so'].SaturateVec3ByScalar
...
SaturateVec = _libraries['control/_pack_ground_telemetry.so'].SaturateVec
...
SaturateArrayByScalar = _libraries['control/_pack_ground_telemetry.so'].SaturateArrayByScalar
...
SaturateInt32 = _libraries['control/_pack_ground_telemetry.so'].SaturateInt32
SaturateInt32.restype = int32_t
SaturateInt32.argtypes = [int32_t, int32_t, int32_t]
SaturateUint32 = _libraries['control/_pack_ground_telemetry.so'].SaturateUint32
SaturateUint32.restype = uint32_t
SaturateUint32.argtypes = [uint32_t, uint32_t, uint32_t]
SaturateInt64 = _libraries['control/_pack_ground_telemetry.so'].SaturateInt64
SaturateInt64.restype = int64_t
SaturateInt64.argtypes = [int64_t, int64_t, int64_t]
SaturateUint64 = _libraries['control/_pack_ground_telemetry.so'].SaturateUint64
SaturateUint64.restype = uint64_t
SaturateUint64.argtypes = [uint64_t, uint64_t, uint64_t]
SaturateSigned = _libraries['control/_pack_ground_telemetry.so'].SaturateSigned
SaturateSigned.restype = int32_t
SaturateSigned.argtypes = [int32_t, int32_t]
SaturateUnsigned = _libraries['control/_pack_ground_telemetry.so'].SaturateUnsigned
SaturateUnsigned.restype = uint32_t
SaturateUnsigned.argtypes = [uint32_t, int32_t]
SaturateWrapped = _libraries['control/_pack_ground_telemetry.so'].SaturateWrapped
...
CrossfadeVec2 = _libraries['control/_pack_ground_telemetry.so'].CrossfadeVec2
...
CrossfadeVec3 = _libraries['control/_pack_ground_telemetry.so'].CrossfadeVec3
...
CrossfadeMat3 = _libraries['control/_pack_ground_telemetry.so'].CrossfadeMat3
...
CrossfadeArray = _libraries['control/_pack_ground_telemetry.so'].CrossfadeArray
...
InterpIndex = _libraries['control/_pack_ground_telemetry.so'].InterpIndex
...
Interp1 = _libraries['control/_pack_ground_telemetry.so'].Interp1
Interp1.restype = ctypes.c_double
Interp1.argtypes = [ctypes.c_double * 0, ctypes.c_double * 0, int32_t, ctypes.c_double, InterpOption]
Interp1WarpY = _libraries['control/_pack_ground_telemetry.so'].Interp1WarpY
...
Interp2 = _libraries['control/_pack_ground_telemetry.so'].Interp2
...
CircularInterp1 = _libraries['control/_pack_ground_telemetry.so'].CircularInterp1
...
Interp1Vec3 = _libraries['control/_pack_ground_telemetry.so'].Interp1Vec3
...
JoinVec3Arr = _libraries['control/_pack_ground_telemetry.so'].JoinVec3Arr
JoinVec3Arr.restype = None
JoinVec3Arr.argtypes = [ctypes.c_double * 0, ctypes.c_double * 0, ctypes.c_double * 0, int32_t, struct_Vec3 * 0]
DegToRad = _libraries['control/_pack_ground_telemetry.so'].DegToRad
DegToRad.restype = ctypes.c_double
DegToRad.argtypes = [ctypes.c_double]
RadToDeg = _libraries['control/_pack_ground_telemetry.so'].RadToDeg
...
Vec2 = struct_Vec2
kVec2Zero = (struct_Vec2).in_dll(_libraries['control/_pack_ground_telemetry.so'], 'kVec2Zero')
kVec2Ones = (struct_Vec2).in_dll(_libraries['control/_pack_ground_telemetry.so'], 'kVec2Ones')
VEC2_DISP = ['(', 'v', ')', 'printf', '(', '"%s:%u %s = [%.12lf, %.12lf]\'\\n"', ',', '__FILE__', ',', '__LINE__', ',', '#', 'v', ',', '(', 'v', ')', '.', 'x', ',', '(', 'v', ')', '.', 'y', ')'] # macro
Vec2Add = _libraries['control/_pack_ground_telemetry.so'].Vec2Add
Vec2Add.restype = POINTER_T(struct_Vec2)
Vec2Add.argtypes = [POINTER_T(struct_Vec2), POINTER_T(struct_Vec2), POINTER_T(struct_Vec2)]
Vec2Add3 = _libraries['control/_pack_ground_telemetry.so'].Vec2Add3
...
Vec2LinComb3 = _libraries['control/_pack_ground_telemetry.so'].Vec2LinComb3
...
Vec2Mult = _libraries['control/_pack_ground_telemetry.so'].Vec2Mult
...
kVec3Zero = (struct_Vec3).in_dll(_libraries['control/_pack_ground_telemetry.so'], 'kVec3Zero')
kVec3Ones = (struct_Vec3).in_dll(_libraries['control/_pack_ground_telemetry.so'], 'kVec3Ones')
kVec3X = (struct_Vec3).in_dll(_libraries['control/_pack_ground_telemetry.so'], 'kVec3X')
kVec3Y = (struct_Vec3).in_dll(_libraries['control/_pack_ground_telemetry.so'], 'kVec3Y')
kVec3Z = (struct_Vec3).in_dll(_libraries['control/_pack_ground_telemetry.so'], 'kVec3Z')
VEC3_DISP = ['(', 'v', ')', 'printf', '(', '"%s:%u %s = [%.12f, %.12f, %.12f]\'\\n"', ',', '__FILE__', ',', '__LINE__', ',', '#', 'v', ',', '(', 'v', ')', '.', 'x', ',', '(', 'v', ')', '.', 'y', ',', '(', 'v', ')', '.', 'z', ')'] # macro
Vec3Add = _libraries['control/_pack_ground_telemetry.so'].Vec3Add
Vec3Add.restype = POINTER_T(struct_Vec3)
Vec3Add.argtypes = [POINTER_T(struct_Vec3), POINTER_T(struct_Vec3), POINTER_T(struct_Vec3)]
Vec3Add3 = _libraries['control/_pack_ground_telemetry.so'].Vec3Add3
...
Vec3LinComb3 = _libraries['control/_pack_ground_telemetry.so'].Vec3LinComb3
...
Vec3Axpy = _libraries['control/_pack_ground_telemetry.so'].Vec3Axpy
Vec3Axpy.restype = POINTER_T(struct_Vec3)
Vec3Axpy.argtypes = [ctypes.c_double, POINTER_T(struct_Vec3), POINTER_T(struct_Vec3)]
Vec3Mult = _libraries['control/_pack_ground_telemetry.so'].Vec3Mult
...
Vec3Cross = _libraries['control/_pack_ground_telemetry.so'].Vec3Cross
...
GetStrain = _libraries['control/_pack_ground_telemetry.so'].GetStrain
GetStrain.restype = ctypes.c_float
GetStrain.argtypes = [struct_c__SA_LoadcellMessage * 0, POINTER_T(struct_c__SA_StrainLocation)]
GetMutableStrain = _libraries['control/_pack_ground_telemetry.so'].GetMutableStrain
...
struct_c__SA_EstimatorPositionGlasParams._pack_ = True # source:False
struct_c__SA_EstimatorPositionGlasParams._fields_ = [
...
struct_c__SA_CrosswindPathParams._pack_ = True # source:False
struct_c__SA_CrosswindPathParams._fields_ = [
...
struct_c__SA_EstimatorVesselState._pack_ = True # source:False
struct_c__SA_EstimatorVesselState._fields_ = [
...
struct_c__SA_EstimatorApparentWindState._pack_ = True # source:False
struct_c__SA_EstimatorApparentWindState._fields_ = [
...
GetNumFlightModeGates = _libraries['control/_pack_ground_telemetry.so'].GetNumFlightModeGates
GetNumFlightModeGates.restype = int32_t
GetNumFlightModeGates.argtypes = [FlightMode]
InitializationStateToString = _libraries['control/_pack_ground_telemetry.so'].InitializationStateToString
InitializationStateToString.restype = POINTER_T(ctypes.c_char)
InitializationStateToString.argtypes = [InitializationState]
FlightModeToString = _libraries['control/_pack_ground_telemetry.so'].FlightModeToString
...
CrosswindNormalGateToString = _libraries['control/_pack_ground_telemetry.so'].CrosswindNormalGateToString
CrosswindNormalGateToString.restype = POINTER_T(ctypes.c_char)
CrosswindNormalGateToString.argtypes = [CrosswindNormalGate]
CrosswindPrepTransOutGateToString = _libraries['control/_pack_ground_telemetry.so'].CrosswindPrepTransOutGateToString
...
CrosswindHoverTransOutGateToString = _libraries['control/_pack_ground_telemetry.so'].CrosswindHoverTransOutGateToString
...
ApparentWindSolutionTypeToString = _libraries['control/_pack_ground_telemetry.so'].ApparentWindSolutionTypeToString
...
ExperimentTypeToString = _libraries['control/_pack_ground_telemetry.so'].ExperimentTypeToString
...
GetWingGpsPosFault = _libraries['control/_pack_ground_telemetry.so'].GetWingGpsPosFault
...
GetWingGpsVelFault = _libraries['control/_pack_ground_telemetry.so'].GetWingGpsVelFault
...
CONTROL_GROUND_TELEMETRY_H_ = True
class struct_c__SA_GroundEstimatorTelemetry(ctypes.Structure):
    _pack_ = True # source:False
    _fields_ = [
    ('init_state', ctypes.c_int32),
    ('initializing', ctypes.c_int32),
    ('position_corrections', EstimatorPositionCorrections),
    ('attitude_corrections', EstimatorAttitudeCorrections),
    ('gps', EstimatorPositionGpsEstimate),
    ('cov_vel_g', Vec3),
    ('cov_pos_g', Vec3),
    ('gyro_biases', Vec3),
    ('cov_attitude_err', Vec3),
    ('cov_gyro_bias', Vec3),
     ]

GroundEstimatorTelemetry = struct_c__SA_GroundEstimatorTelemetry
class struct_c__SA_GroundTelemetry(ctypes.Structure):
    _pack_ = True # source:False
    _fields_ = [
    ('estimator', GroundEstimatorTelemetry),
    ('input', GroundEstimatorInput),
    ('estimate', GroundEstimateMessage),
     ]

GroundTelemetry = struct_c__SA_GroundTelemetry
GetGroundTelemetryMessage = _libraries['control/_pack_ground_telemetry.so'].GetGroundTelemetryMessage
GetGroundTelemetryMessage.restype = POINTER_T(struct_c__SA_GroundTelemetry)
GetGroundTelemetryMessage.argtypes = []
...
HoverAscendGateToString = _libraries['control/_pack_ground_telemetry.so'].HoverAscendGateToString
HoverAscendGateToString.restype = POINTER_T(ctypes.c_char)
HoverAscendGateToString.argtypes = [HoverAscendGate]
HoverPayOutGateToString = _libraries['control/_pack_ground_telemetry.so'].HoverPayOutGateToString
HoverPayOutGateToString.restype = POINTER_T(ctypes.c_char)
HoverPayOutGateToString.argtypes = [HoverPayOutGate]
HoverFullLengthGateToString = _libraries['control/_pack_ground_telemetry.so'].HoverFullLengthGateToString
HoverFullLengthGateToString.restype = POINTER_T(ctypes.c_char)
HoverFullLengthGateToString.argtypes = [HoverFullLengthGate]
HoverPrepTransformGsUpGateToString = _libraries['control/_pack_ground_telemetry.so'].HoverPrepTransformGsUpGateToString
...
HoverTransformGsUpGateToString = _libraries['control/_pack_ground_telemetry.so'].HoverTransformGsUpGateToString
...
HoverAccelGateToString = _libraries['control/_pack_ground_telemetry.so'].HoverAccelGateToString
HoverAccelGateToString.restype = POINTER_T(ctypes.c_char)
HoverAccelGateToString.argtypes = [HoverAccelGate]
HoverPrepTransformGsDownGateToString = _libraries['control/_pack_ground_telemetry.so'].HoverPrepTransformGsDownGateToString
...
HoverTransformGsDownGateToString = _libraries['control/_pack_ground_telemetry.so'].HoverTransformGsDownGateToString
...
HoverReelInGateToString = _libraries['control/_pack_ground_telemetry.so'].HoverReelInGateToString
HoverReelInGateToString.restype = POINTER_T(ctypes.c_char)
HoverReelInGateToString.argtypes = [HoverReelInGate]
HoverDescendGateToString = _libraries['control/_pack_ground_telemetry.so'].HoverDescendGateToString
HoverDescendGateToString.restype = POINTER_T(ctypes.c_char)
HoverDescendGateToString.argtypes = [HoverDescendGate]
HoverPerchedGateToString = _libraries['control/_pack_ground_telemetry.so'].HoverPerchedGateToString
...
FlightPlanToString = _libraries['control/_pack_ground_telemetry.so'].FlightPlanToString
FlightPlanToString.restype = POINTER_T(ctypes.c_char)
FlightPlanToString.argtypes = [FlightPlan]
GroundStationModelToString = _libraries['control/_pack_ground_telemetry.so'].GroundStationModelToString
GroundStationModelToString.restype = POINTER_T(ctypes.c_char)
GroundStationModelToString.argtypes = [GroundStationModel]
TestSiteToString = _libraries['control/_pack_ground_telemetry.so'].TestSiteToString
TestSiteToString.restype = POINTER_T(ctypes.c_char)
TestSiteToString.argtypes = [TestSite]
WingSerialToString = _libraries['control/_pack_ground_telemetry.so'].WingSerialToString
WingSerialToString.restype = POINTER_T(ctypes.c_char)
WingSerialToString.argtypes = [WingSerial]
WingSerialToModel = _libraries['control/_pack_ground_telemetry.so'].WingSerialToModel
WingSerialToModel.restype = ctypes.c_int32
WingSerialToModel.argtypes = [WingSerial]
IsLowAltitudeFlightPlan = _libraries['control/_pack_ground_telemetry.so'].IsLowAltitudeFlightPlan
...
BridleAndChannelToLoadcellSensorLabel = _libraries['control/_pack_ground_telemetry.so'].BridleAndChannelToLoadcellSensorLabel
...
TransInGateToString = _libraries['control/_pack_ground_telemetry.so'].TransInGateToString
...
CONTROL_PACK_GROUND_TELEMETRY_H_ = True
PACK_GROUNDESTIMATORTELEMETRY_SIZE = 2979
size_t = ctypes.c_uint64
PackGroundEstimatorTelemetry = _libraries['control/_pack_ground_telemetry.so'].PackGroundEstimatorTelemetry
PackGroundEstimatorTelemetry.restype = size_t
PackGroundEstimatorTelemetry.argtypes = [POINTER_T(struct_c__SA_GroundEstimatorTelemetry), size_t, POINTER_T(ctypes.c_ubyte)]
UnpackGroundEstimatorTelemetry = _libraries['control/_pack_ground_telemetry.so'].UnpackGroundEstimatorTelemetry
UnpackGroundEstimatorTelemetry.restype = size_t
UnpackGroundEstimatorTelemetry.argtypes = [POINTER_T(ctypes.c_ubyte), size_t, POINTER_T(struct_c__SA_GroundEstimatorTelemetry)]
PACK_GROUNDTELEMETRY_SIZE = 3371
PackGroundTelemetry = _libraries['control/_pack_ground_telemetry.so'].PackGroundTelemetry
PackGroundTelemetry.restype = size_t
PackGroundTelemetry.argtypes = [POINTER_T(struct_c__SA_GroundTelemetry), size_t, POINTER_T(ctypes.c_ubyte)]
UnpackGroundTelemetry = _libraries['control/_pack_ground_telemetry.so'].UnpackGroundTelemetry
UnpackGroundTelemetry.restype = size_t
UnpackGroundTelemetry.argtypes = [POINTER_T(ctypes.c_ubyte), size_t, POINTER_T(struct_c__SA_GroundTelemetry)]
_ASSERT_H = 1
__ASSERT_VOID_CAST = ['(', 'void', ')'] # macro
_ASSERT_H_DECLS = True
__assert_fail = _libraries['control/_pack_ground_telemetry.so'].__assert_fail
...
__assert_perror_fail = _libraries['control/_pack_ground_telemetry.so'].__assert_perror_fail
...
__assert = _libraries['control/_pack_ground_telemetry.so'].__assert
...
strtok_r = _libraries['control/_pack_ground_telemetry.so'].strtok_r
...
AioAnalogGetConfig = _libraries['control/_pack_ground_telemetry.so'].AioAnalogGetConfig
...
AioIna219GetConfig = _libraries['control/_pack_ground_telemetry.so'].AioIna219GetConfig
...
AioSi7021GetConfig = _libraries['control/_pack_ground_telemetry.so'].AioSi7021GetConfig
...
BattAnalogGetConfig = _libraries['control/_pack_ground_telemetry.so'].BattAnalogGetConfig
...
BattBq34z100GetConfig = _libraries['control/_pack_ground_telemetry.so'].BattBq34z100GetConfig
...
BattLtc4151GetConfig = _libraries['control/_pack_ground_telemetry.so'].BattLtc4151GetConfig
...
BattMcp342xGetConfig = _libraries['control/_pack_ground_telemetry.so'].BattMcp342xGetConfig
...
CsAnalogGetConfig = _libraries['control/_pack_ground_telemetry.so'].CsAnalogGetConfig
...
CsIna219GetConfig = _libraries['control/_pack_ground_telemetry.so'].CsIna219GetConfig
...
CsSi7021GetConfig = _libraries['control/_pack_ground_telemetry.so'].CsSi7021GetConfig
...
FcAnalogGetConfig = _libraries['control/_pack_ground_telemetry.so'].FcAnalogGetConfig
...
FcIna219GetConfig = _libraries['control/_pack_ground_telemetry.so'].FcIna219GetConfig
...
GroundIoAds7828GetConfig = _libraries['control/_pack_ground_telemetry.so'].GroundIoAds7828GetConfig
...
GroundIoAnalogGetConfig = _libraries['control/_pack_ground_telemetry.so'].GroundIoAnalogGetConfig
...
JoystickAnalogGetConfig = _libraries['control/_pack_ground_telemetry.so'].JoystickAnalogGetConfig
...
JoystickIna219GetConfig = _libraries['control/_pack_ground_telemetry.so'].JoystickIna219GetConfig
...
LoadcellAnalogGetConfig = _libraries['control/_pack_ground_telemetry.so'].LoadcellAnalogGetConfig
...
MvlvAnalogGetConfig = _libraries['control/_pack_ground_telemetry.so'].MvlvAnalogGetConfig
...
MvlvLtc2309GetConfig = _libraries['control/_pack_ground_telemetry.so'].MvlvLtc2309GetConfig
...
MvlvMcp342xGetConfig = _libraries['control/_pack_ground_telemetry.so'].MvlvMcp342xGetConfig
...
RecorderAnalogGetConfig = _libraries['control/_pack_ground_telemetry.so'].RecorderAnalogGetConfig
...
RecorderIna219GetConfig = _libraries['control/_pack_ground_telemetry.so'].RecorderIna219GetConfig
...
ServoAnalogGetConfig = _libraries['control/_pack_ground_telemetry.so'].ServoAnalogGetConfig
...
ServoMcp342xGetConfig = _libraries['control/_pack_ground_telemetry.so'].ServoMcp342xGetConfig
...
ServoMcp9800GetConfig = _libraries['control/_pack_ground_telemetry.so'].ServoMcp9800GetConfig
...
ShortStackAnalogGetConfig = _libraries['control/_pack_ground_telemetry.so'].ShortStackAnalogGetConfig
...
ShortStackMcp342xGetConfig = _libraries['control/_pack_ground_telemetry.so'].ShortStackMcp342xGetConfig
...
MotorIna219GetConfig = _libraries['control/_pack_ground_telemetry.so'].MotorIna219GetConfig
...
MotorSi7021GetConfig = _libraries['control/_pack_ground_telemetry.so'].MotorSi7021GetConfig
...
BattLabelToBattAioNode = _libraries['control/_pack_ground_telemetry.so'].BattLabelToBattAioNode
BattLabelToBattAioNode.restype = AioNode
BattLabelToBattAioNode.argtypes = [BattLabel]
BattAioNodeToBattLabel = _libraries['control/_pack_ground_telemetry.so'].BattAioNodeToBattLabel
BattAioNodeToBattLabel.restype = BattLabel
BattAioNodeToBattLabel.argtypes = [AioNode]
CmdLabelToCmdAioNode = _libraries['control/_pack_ground_telemetry.so'].CmdLabelToCmdAioNode
CmdLabelToCmdAioNode.restype = AioNode
CmdLabelToCmdAioNode.argtypes = [CmdLabel]
CmdAioNodeToCmdLabel = _libraries['control/_pack_ground_telemetry.so'].CmdAioNodeToCmdLabel
CmdAioNodeToCmdLabel.restype = CmdLabel
CmdAioNodeToCmdLabel.argtypes = [AioNode]
ControllerLabelToControllerAioNode = _libraries['control/_pack_ground_telemetry.so'].ControllerLabelToControllerAioNode
ControllerLabelToControllerAioNode.restype = AioNode
ControllerLabelToControllerAioNode.argtypes = [ControllerLabel]
ControllerAioNodeToControllerLabel = _libraries['control/_pack_ground_telemetry.so'].ControllerAioNodeToControllerLabel
ControllerAioNodeToControllerLabel.restype = ControllerLabel
ControllerAioNodeToControllerLabel.argtypes = [AioNode]
CoreSwitchLabelToCoreSwitchAioNode = _libraries['control/_pack_ground_telemetry.so'].CoreSwitchLabelToCoreSwitchAioNode
CoreSwitchLabelToCoreSwitchAioNode.restype = AioNode
CoreSwitchLabelToCoreSwitchAioNode.argtypes = [CoreSwitchLabel]
CoreSwitchAioNodeToCoreSwitchLabel = _libraries['control/_pack_ground_telemetry.so'].CoreSwitchAioNodeToCoreSwitchLabel
CoreSwitchAioNodeToCoreSwitchLabel.restype = CoreSwitchLabel
CoreSwitchAioNodeToCoreSwitchLabel.argtypes = [AioNode]
DrumLabelToDrumAioNode = _libraries['control/_pack_ground_telemetry.so'].DrumLabelToDrumAioNode
DrumLabelToDrumAioNode.restype = AioNode
DrumLabelToDrumAioNode.argtypes = [DrumLabel]
DrumAioNodeToDrumLabel = _libraries['control/_pack_ground_telemetry.so'].DrumAioNodeToDrumLabel
DrumAioNodeToDrumLabel.restype = DrumLabel
DrumAioNodeToDrumLabel.argtypes = [AioNode]
DynoMotorLabelToDynoMotorAioNode = _libraries['control/_pack_ground_telemetry.so'].DynoMotorLabelToDynoMotorAioNode
DynoMotorLabelToDynoMotorAioNode.restype = AioNode
DynoMotorLabelToDynoMotorAioNode.argtypes = [DynoMotorLabel]
DynoMotorAioNodeToDynoMotorLabel = _libraries['control/_pack_ground_telemetry.so'].DynoMotorAioNodeToDynoMotorLabel
DynoMotorAioNodeToDynoMotorLabel.restype = DynoMotorLabel
DynoMotorAioNodeToDynoMotorLabel.argtypes = [AioNode]
EopLabelToEopAioNode = _libraries['control/_pack_ground_telemetry.so'].EopLabelToEopAioNode
EopLabelToEopAioNode.restype = AioNode
EopLabelToEopAioNode.argtypes = [EopLabel]
EopAioNodeToEopLabel = _libraries['control/_pack_ground_telemetry.so'].EopAioNodeToEopLabel
EopAioNodeToEopLabel.restype = EopLabel
EopAioNodeToEopLabel.argtypes = [AioNode]
FlightComputerLabelToFlightComputerAioNode = _libraries['control/_pack_ground_telemetry.so'].FlightComputerLabelToFlightComputerAioNode
...
FlightComputerAioNodeToFlightComputerLabel = _libraries['control/_pack_ground_telemetry.so'].FlightComputerAioNodeToFlightComputerLabel
...
GpsLabelToGpsAioNode = _libraries['control/_pack_ground_telemetry.so'].GpsLabelToGpsAioNode
GpsLabelToGpsAioNode.restype = AioNode
GpsLabelToGpsAioNode.argtypes = [GpsLabel]
GpsAioNodeToGpsLabel = _libraries['control/_pack_ground_telemetry.so'].GpsAioNodeToGpsLabel
GpsAioNodeToGpsLabel.restype = GpsLabel
GpsAioNodeToGpsLabel.argtypes = [AioNode]
GroundPowerQ7LabelToGroundPowerQ7AioNode = _libraries['control/_pack_ground_telemetry.so'].GroundPowerQ7LabelToGroundPowerQ7AioNode
...
GroundPowerQ7AioNodeToGroundPowerQ7Label = _libraries['control/_pack_ground_telemetry.so'].GroundPowerQ7AioNodeToGroundPowerQ7Label
...
GroundPowerTms570LabelToGroundPowerTms570AioNode = _libraries['control/_pack_ground_telemetry.so'].GroundPowerTms570LabelToGroundPowerTms570AioNode
...
GroundPowerTms570AioNodeToGroundPowerTms570Label = _libraries['control/_pack_ground_telemetry.so'].GroundPowerTms570AioNodeToGroundPowerTms570Label
...
GsEstimatorLabelToGsEstimatorAioNode = _libraries['control/_pack_ground_telemetry.so'].GsEstimatorLabelToGsEstimatorAioNode
GsEstimatorLabelToGsEstimatorAioNode.restype = AioNode
GsEstimatorLabelToGsEstimatorAioNode.argtypes = [GsEstimatorLabel]
GsEstimatorAioNodeToGsEstimatorLabel = _libraries['control/_pack_ground_telemetry.so'].GsEstimatorAioNodeToGsEstimatorLabel
GsEstimatorAioNodeToGsEstimatorLabel.restype = GsEstimatorLabel
GsEstimatorAioNodeToGsEstimatorLabel.argtypes = [AioNode]
JoystickLabelToJoystickAioNode = _libraries['control/_pack_ground_telemetry.so'].JoystickLabelToJoystickAioNode
JoystickLabelToJoystickAioNode.restype = AioNode
JoystickLabelToJoystickAioNode.argtypes = [JoystickLabel]
JoystickAioNodeToJoystickLabel = _libraries['control/_pack_ground_telemetry.so'].JoystickAioNodeToJoystickLabel
JoystickAioNodeToJoystickLabel.restype = JoystickLabel
JoystickAioNodeToJoystickLabel.argtypes = [AioNode]
LightLabelToLightAioNode = _libraries['control/_pack_ground_telemetry.so'].LightLabelToLightAioNode
LightLabelToLightAioNode.restype = AioNode
LightLabelToLightAioNode.argtypes = [LightLabel]
LightAioNodeToLightLabel = _libraries['control/_pack_ground_telemetry.so'].LightAioNodeToLightLabel
LightAioNodeToLightLabel.restype = LightLabel
LightAioNodeToLightLabel.argtypes = [AioNode]
LoadcellNodeLabelToLoadcellNodeAioNode = _libraries['control/_pack_ground_telemetry.so'].LoadcellNodeLabelToLoadcellNodeAioNode
LoadcellNodeLabelToLoadcellNodeAioNode.restype = AioNode
LoadcellNodeLabelToLoadcellNodeAioNode.argtypes = [LoadcellNodeLabel]
LoadcellNodeAioNodeToLoadcellNodeLabel = _libraries['control/_pack_ground_telemetry.so'].LoadcellNodeAioNodeToLoadcellNodeLabel
LoadcellNodeAioNodeToLoadcellNodeLabel.restype = LoadcellNodeLabel
LoadcellNodeAioNodeToLoadcellNodeLabel.argtypes = [AioNode]
MotorLabelToMotorAioNode = _libraries['control/_pack_ground_telemetry.so'].MotorLabelToMotorAioNode
MotorLabelToMotorAioNode.restype = AioNode
MotorLabelToMotorAioNode.argtypes = [MotorLabel]
MotorAioNodeToMotorLabel = _libraries['control/_pack_ground_telemetry.so'].MotorAioNodeToMotorLabel
MotorAioNodeToMotorLabel.restype = MotorLabel
MotorAioNodeToMotorLabel.argtypes = [AioNode]
MvlvLabelToMvlvAioNode = _libraries['control/_pack_ground_telemetry.so'].MvlvLabelToMvlvAioNode
MvlvLabelToMvlvAioNode.restype = AioNode
MvlvLabelToMvlvAioNode.argtypes = [MvlvLabel]
MvlvAioNodeToMvlvLabel = _libraries['control/_pack_ground_telemetry.so'].MvlvAioNodeToMvlvLabel
MvlvAioNodeToMvlvLabel.restype = MvlvLabel
MvlvAioNodeToMvlvLabel.argtypes = [AioNode]
OperatorLabelToOperatorAioNode = _libraries['control/_pack_ground_telemetry.so'].OperatorLabelToOperatorAioNode
OperatorLabelToOperatorAioNode.restype = AioNode
OperatorLabelToOperatorAioNode.argtypes = [OperatorLabel]
OperatorAioNodeToOperatorLabel = _libraries['control/_pack_ground_telemetry.so'].OperatorAioNodeToOperatorLabel
OperatorAioNodeToOperatorLabel.restype = OperatorLabel
OperatorAioNodeToOperatorLabel.argtypes = [AioNode]
PlatformLabelToPlatformAioNode = _libraries['control/_pack_ground_telemetry.so'].PlatformLabelToPlatformAioNode
PlatformLabelToPlatformAioNode.restype = AioNode
PlatformLabelToPlatformAioNode.argtypes = [PlatformLabel]
PlatformAioNodeToPlatformLabel = _libraries['control/_pack_ground_telemetry.so'].PlatformAioNodeToPlatformLabel
PlatformAioNodeToPlatformLabel.restype = PlatformLabel
PlatformAioNodeToPlatformLabel.argtypes = [AioNode]
PlcGs02LabelToPlcGs02AioNode = _libraries['control/_pack_ground_telemetry.so'].PlcGs02LabelToPlcGs02AioNode
PlcGs02LabelToPlcGs02AioNode.restype = AioNode
PlcGs02LabelToPlcGs02AioNode.argtypes = [PlcGs02Label]
PlcGs02AioNodeToPlcGs02Label = _libraries['control/_pack_ground_telemetry.so'].PlcGs02AioNodeToPlcGs02Label
PlcGs02AioNodeToPlcGs02Label.restype = PlcGs02Label
PlcGs02AioNodeToPlcGs02Label.argtypes = [AioNode]
PlcTophatLabelToPlcTophatAioNode = _libraries['control/_pack_ground_telemetry.so'].PlcTophatLabelToPlcTophatAioNode
PlcTophatLabelToPlcTophatAioNode.restype = AioNode
PlcTophatLabelToPlcTophatAioNode.argtypes = [PlcTophatLabel]
PlcTophatAioNodeToPlcTophatLabel = _libraries['control/_pack_ground_telemetry.so'].PlcTophatAioNodeToPlcTophatLabel
PlcTophatAioNodeToPlcTophatLabel.restype = PlcTophatLabel
PlcTophatAioNodeToPlcTophatLabel.argtypes = [AioNode]
RecorderQ7LabelToRecorderQ7AioNode = _libraries['control/_pack_ground_telemetry.so'].RecorderQ7LabelToRecorderQ7AioNode
RecorderQ7LabelToRecorderQ7AioNode.restype = AioNode
RecorderQ7LabelToRecorderQ7AioNode.argtypes = [RecorderQ7Label]
RecorderQ7AioNodeToRecorderQ7Label = _libraries['control/_pack_ground_telemetry.so'].RecorderQ7AioNodeToRecorderQ7Label
RecorderQ7AioNodeToRecorderQ7Label.restype = RecorderQ7Label
RecorderQ7AioNodeToRecorderQ7Label.argtypes = [AioNode]
RecorderTms570LabelToRecorderTms570AioNode = _libraries['control/_pack_ground_telemetry.so'].RecorderTms570LabelToRecorderTms570AioNode
...
RecorderTms570AioNodeToRecorderTms570Label = _libraries['control/_pack_ground_telemetry.so'].RecorderTms570AioNodeToRecorderTms570Label
...
ServoLabelToServoAioNode = _libraries['control/_pack_ground_telemetry.so'].ServoLabelToServoAioNode
ServoLabelToServoAioNode.restype = AioNode
ServoLabelToServoAioNode.argtypes = [ServoLabel]
ServoAioNodeToServoLabel = _libraries['control/_pack_ground_telemetry.so'].ServoAioNodeToServoLabel
ServoAioNodeToServoLabel.restype = ServoLabel
ServoAioNodeToServoLabel.argtypes = [AioNode]
ShortStackLabelToShortStackAioNode = _libraries['control/_pack_ground_telemetry.so'].ShortStackLabelToShortStackAioNode
ShortStackLabelToShortStackAioNode.restype = AioNode
ShortStackLabelToShortStackAioNode.argtypes = [ShortStackLabel]
ShortStackAioNodeToShortStackLabel = _libraries['control/_pack_ground_telemetry.so'].ShortStackAioNodeToShortStackLabel
ShortStackAioNodeToShortStackLabel.restype = ShortStackLabel
ShortStackAioNodeToShortStackLabel.argtypes = [AioNode]
SimulatedJoystickLabelToSimulatedJoystickAioNode = _libraries['control/_pack_ground_telemetry.so'].SimulatedJoystickLabelToSimulatedJoystickAioNode
...
SimulatedJoystickAioNodeToSimulatedJoystickLabel = _libraries['control/_pack_ground_telemetry.so'].SimulatedJoystickAioNodeToSimulatedJoystickLabel
...
SimulatorLabelToSimulatorAioNode = _libraries['control/_pack_ground_telemetry.so'].SimulatorLabelToSimulatorAioNode
SimulatorLabelToSimulatorAioNode.restype = AioNode
SimulatorLabelToSimulatorAioNode.argtypes = [SimulatorLabel]
SimulatorAioNodeToSimulatorLabel = _libraries['control/_pack_ground_telemetry.so'].SimulatorAioNodeToSimulatorLabel
SimulatorAioNodeToSimulatorLabel.restype = SimulatorLabel
SimulatorAioNodeToSimulatorLabel.argtypes = [AioNode]
TelemetrySnapshotLabelToTelemetrySnapshotAioNode = _libraries['control/_pack_ground_telemetry.so'].TelemetrySnapshotLabelToTelemetrySnapshotAioNode
...
TelemetrySnapshotAioNodeToTelemetrySnapshotLabel = _libraries['control/_pack_ground_telemetry.so'].TelemetrySnapshotAioNodeToTelemetrySnapshotLabel
...
TorqueCellLabelToTorqueCellAioNode = _libraries['control/_pack_ground_telemetry.so'].TorqueCellLabelToTorqueCellAioNode
TorqueCellLabelToTorqueCellAioNode.restype = AioNode
TorqueCellLabelToTorqueCellAioNode.argtypes = [TorqueCellLabel]
TorqueCellAioNodeToTorqueCellLabel = _libraries['control/_pack_ground_telemetry.so'].TorqueCellAioNodeToTorqueCellLabel
TorqueCellAioNodeToTorqueCellLabel.restype = TorqueCellLabel
TorqueCellAioNodeToTorqueCellLabel.argtypes = [AioNode]
UwbLabelToUwbAioNode = _libraries['control/_pack_ground_telemetry.so'].UwbLabelToUwbAioNode
UwbLabelToUwbAioNode.restype = AioNode
UwbLabelToUwbAioNode.argtypes = [UwbLabel]
UwbAioNodeToUwbLabel = _libraries['control/_pack_ground_telemetry.so'].UwbAioNodeToUwbLabel
UwbAioNodeToUwbLabel.restype = UwbLabel
UwbAioNodeToUwbLabel.argtypes = [AioNode]
VisualizerLabelToVisualizerAioNode = _libraries['control/_pack_ground_telemetry.so'].VisualizerLabelToVisualizerAioNode
VisualizerLabelToVisualizerAioNode.restype = AioNode
VisualizerLabelToVisualizerAioNode.argtypes = [VisualizerLabel]
VisualizerAioNodeToVisualizerLabel = _libraries['control/_pack_ground_telemetry.so'].VisualizerAioNodeToVisualizerLabel
VisualizerAioNodeToVisualizerLabel.restype = VisualizerLabel
VisualizerAioNodeToVisualizerLabel.argtypes = [AioNode]
BattLabelToString = _libraries['control/_pack_ground_telemetry.so'].BattLabelToString
BattLabelToString.restype = POINTER_T(ctypes.c_char)
BattLabelToString.argtypes = [BattLabel]
CmdLabelToString = _libraries['control/_pack_ground_telemetry.so'].CmdLabelToString
CmdLabelToString.restype = POINTER_T(ctypes.c_char)
CmdLabelToString.argtypes = [CmdLabel]
ControllerLabelToString = _libraries['control/_pack_ground_telemetry.so'].ControllerLabelToString
ControllerLabelToString.restype = POINTER_T(ctypes.c_char)
ControllerLabelToString.argtypes = [ControllerLabel]
CoreSwitchLabelToString = _libraries['control/_pack_ground_telemetry.so'].CoreSwitchLabelToString
CoreSwitchLabelToString.restype = POINTER_T(ctypes.c_char)
CoreSwitchLabelToString.argtypes = [CoreSwitchLabel]
DrumLabelToString = _libraries['control/_pack_ground_telemetry.so'].DrumLabelToString
DrumLabelToString.restype = POINTER_T(ctypes.c_char)
DrumLabelToString.argtypes = [DrumLabel]
DynoMotorLabelToString = _libraries['control/_pack_ground_telemetry.so'].DynoMotorLabelToString
DynoMotorLabelToString.restype = POINTER_T(ctypes.c_char)
DynoMotorLabelToString.argtypes = [DynoMotorLabel]
EopLabelToString = _libraries['control/_pack_ground_telemetry.so'].EopLabelToString
EopLabelToString.restype = POINTER_T(ctypes.c_char)
EopLabelToString.argtypes = [EopLabel]
FlightComputerLabelToString = _libraries['control/_pack_ground_telemetry.so'].FlightComputerLabelToString
FlightComputerLabelToString.restype = POINTER_T(ctypes.c_char)
FlightComputerLabelToString.argtypes = [FlightComputerLabel]
GpsLabelToString = _libraries['control/_pack_ground_telemetry.so'].GpsLabelToString
GpsLabelToString.restype = POINTER_T(ctypes.c_char)
GpsLabelToString.argtypes = [GpsLabel]
GroundPowerQ7LabelToString = _libraries['control/_pack_ground_telemetry.so'].GroundPowerQ7LabelToString
GroundPowerQ7LabelToString.restype = POINTER_T(ctypes.c_char)
GroundPowerQ7LabelToString.argtypes = [GroundPowerQ7Label]
GroundPowerTms570LabelToString = _libraries['control/_pack_ground_telemetry.so'].GroundPowerTms570LabelToString
...
SimulatorLabelToString = _libraries['control/_pack_ground_telemetry.so'].SimulatorLabelToString
SimulatorLabelToString.restype = POINTER_T(ctypes.c_char)
SimulatorLabelToString.argtypes = [SimulatorLabel]
TelemetrySnapshotLabelToString = _libraries['control/_pack_ground_telemetry.so'].TelemetrySnapshotLabelToString
...
TorqueCellLabelToString = _libraries['control/_pack_ground_telemetry.so'].TorqueCellLabelToString
TorqueCellLabelToString.restype = POINTER_T(ctypes.c_char)
TorqueCellLabelToString.argtypes = [TorqueCellLabel]
UwbLabelToString = _libraries['control/_pack_ground_telemetry.so'].UwbLabelToString
UwbLabelToString.restype = POINTER_T(ctypes.c_char)
UwbLabelToString.argtypes = [UwbLabel]
VisualizerLabelToString = _libraries['control/_pack_ground_telemetry.so'].VisualizerLabelToString
...
AioNodeToString = _libraries['control/_pack_ground_telemetry.so'].AioNodeToString
AioNodeToString.restype = POINTER_T(ctypes.c_char)
AioNodeToString.argtypes = [AioNode]
AioNodeToShortString = _libraries['control/_pack_ground_telemetry.so'].AioNodeToShortString
AioNodeToShortString.restype = POINTER_T(ctypes.c_char)
AioNodeToShortString.argtypes = [AioNode]
StringToAioNode = _libraries['control/_pack_ground_telemetry.so'].StringToAioNode
StringToAioNode.restype = AioNode
StringToAioNode.argtypes = [POINTER_T(ctypes.c_char)]
IsQ7Node = _libraries['control/_pack_ground_telemetry.so'].IsQ7Node
IsQ7Node.restype = ctypes.c_bool
IsQ7Node.argtypes = [AioNode]
IsTms570Node = _libraries['control/_pack_ground_telemetry.so'].IsTms570Node
IsTms570Node.restype = ctypes.c_bool
IsTms570Node.argtypes = [AioNode]
IsValidNode = _libraries['control/_pack_ground_telemetry.so'].IsValidNode
IsValidNode.restype = ctypes.c_bool
IsValidNode.argtypes = [AioNode]
IsRemoteCommandNode = _libraries['control/_pack_ground_telemetry.so'].IsRemoteCommandNode
IsRemoteCommandNode.restype = ctypes.c_bool
IsRemoteCommandNode.argtypes = [AioNode]
IsWingNode = _libraries['control/_pack_ground_telemetry.so'].IsWingNode
IsWingNode.restype = ctypes.c_bool
IsWingNode.argtypes = [AioNode]
IsGroundStationNode = _libraries['control/_pack_ground_telemetry.so'].IsGroundStationNode
IsGroundStationNode.restype = ctypes.c_bool
IsGroundStationNode.argtypes = [AioNode]
IsTestFixtureNode = _libraries['control/_pack_ground_telemetry.so'].IsTestFixtureNode
IsTestFixtureNode.restype = ctypes.c_bool
IsTestFixtureNode.argtypes = [AioNode]
IsBattNode = _libraries['control/_pack_ground_telemetry.so'].IsBattNode
IsBattNode.restype = ctypes.c_bool
IsBattNode.argtypes = [AioNode]
IsCmdNode = _libraries['control/_pack_ground_telemetry.so'].IsCmdNode
IsCmdNode.restype = ctypes.c_bool
IsCmdNode.argtypes = [AioNode]
IsControllerNode = _libraries['control/_pack_ground_telemetry.so'].IsControllerNode
IsControllerNode.restype = ctypes.c_bool
IsControllerNode.argtypes = [AioNode]
IsCoreSwitchNode = _libraries['control/_pack_ground_telemetry.so'].IsCoreSwitchNode
IsCoreSwitchNode.restype = ctypes.c_bool
IsCoreSwitchNode.argtypes = [AioNode]
IsDrumNode = _libraries['control/_pack_ground_telemetry.so'].IsDrumNode
IsDrumNode.restype = ctypes.c_bool
IsDrumNode.argtypes = [AioNode]
IsDynoMotorNode = _libraries['control/_pack_ground_telemetry.so'].IsDynoMotorNode
IsDynoMotorNode.restype = ctypes.c_bool
IsDynoMotorNode.argtypes = [AioNode]
IsEopNode = _libraries['control/_pack_ground_telemetry.so'].IsEopNode
IsEopNode.restype = ctypes.c_bool
IsEopNode.argtypes = [AioNode]
IsFlightComputerNode = _libraries['control/_pack_ground_telemetry.so'].IsFlightComputerNode
IsFlightComputerNode.restype = ctypes.c_bool
IsFlightComputerNode.argtypes = [AioNode]
IsGpsNode = _libraries['control/_pack_ground_telemetry.so'].IsGpsNode
IsGpsNode.restype = ctypes.c_bool
IsGpsNode.argtypes = [AioNode]
IsGroundPowerQ7Node = _libraries['control/_pack_ground_telemetry.so'].IsGroundPowerQ7Node
IsGroundPowerQ7Node.restype = ctypes.c_bool
IsGroundPowerQ7Node.argtypes = [AioNode]
IsGroundPowerTms570Node = _libraries['control/_pack_ground_telemetry.so'].IsGroundPowerTms570Node
IsGroundPowerTms570Node.restype = ctypes.c_bool
IsGroundPowerTms570Node.argtypes = [AioNode]
IsGsEstimatorNode = _libraries['control/_pack_ground_telemetry.so'].IsGsEstimatorNode
IsGsEstimatorNode.restype = ctypes.c_bool
IsGsEstimatorNode.argtypes = [AioNode]
IsJoystickNode = _libraries['control/_pack_ground_telemetry.so'].IsJoystickNode
IsJoystickNode.restype = ctypes.c_bool
IsJoystickNode.argtypes = [AioNode]
IsLightNode = _libraries['control/_pack_ground_telemetry.so'].IsLightNode
IsLightNode.restype = ctypes.c_bool
IsLightNode.argtypes = [AioNode]
IsLoadcellNodeNode = _libraries['control/_pack_ground_telemetry.so'].IsLoadcellNodeNode
IsLoadcellNodeNode.restype = ctypes.c_bool
IsLoadcellNodeNode.argtypes = [AioNode]
IsMotorNode = _libraries['control/_pack_ground_telemetry.so'].IsMotorNode
IsMotorNode.restype = ctypes.c_bool
IsMotorNode.argtypes = [AioNode]
IsMvlvNode = _libraries['control/_pack_ground_telemetry.so'].IsMvlvNode
IsMvlvNode.restype = ctypes.c_bool
IsMvlvNode.argtypes = [AioNode]
IsOperatorNode = _libraries['control/_pack_ground_telemetry.so'].IsOperatorNode
IsOperatorNode.restype = ctypes.c_bool
IsOperatorNode.argtypes = [AioNode]
IsPlatformNode = _libraries['control/_pack_ground_telemetry.so'].IsPlatformNode
IsPlatformNode.restype = ctypes.c_bool
IsPlatformNode.argtypes = [AioNode]
IsPlcGs02Node = _libraries['control/_pack_ground_telemetry.so'].IsPlcGs02Node
IsPlcGs02Node.restype = ctypes.c_bool
IsPlcGs02Node.argtypes = [AioNode]
IsPlcTophatNode = _libraries['control/_pack_ground_telemetry.so'].IsPlcTophatNode
IsPlcTophatNode.restype = ctypes.c_bool
IsPlcTophatNode.argtypes = [AioNode]
IsRecorderQ7Node = _libraries['control/_pack_ground_telemetry.so'].IsRecorderQ7Node
IsRecorderQ7Node.restype = ctypes.c_bool
IsRecorderQ7Node.argtypes = [AioNode]
IsRecorderTms570Node = _libraries['control/_pack_ground_telemetry.so'].IsRecorderTms570Node
IsRecorderTms570Node.restype = ctypes.c_bool
IsRecorderTms570Node.argtypes = [AioNode]
IsServoNode = _libraries['control/_pack_ground_telemetry.so'].IsServoNode
IsServoNode.restype = ctypes.c_bool
IsServoNode.argtypes = [AioNode]
IsShortStackNode = _libraries['control/_pack_ground_telemetry.so'].IsShortStackNode
IsShortStackNode.restype = ctypes.c_bool
IsShortStackNode.argtypes = [AioNode]
IsSimulatedJoystickNode = _libraries['control/_pack_ground_telemetry.so'].IsSimulatedJoystickNode
IsSimulatedJoystickNode.restype = ctypes.c_bool
IsSimulatedJoystickNode.argtypes = [AioNode]
IsSimulatorNode = _libraries['control/_pack_ground_telemetry.so'].IsSimulatorNode
IsSimulatorNode.restype = ctypes.c_bool
IsSimulatorNode.argtypes = [AioNode]
IsTelemetrySnapshotNode = _libraries['control/_pack_ground_telemetry.so'].IsTelemetrySnapshotNode
IsTelemetrySnapshotNode.restype = ctypes.c_bool
IsTelemetrySnapshotNode.argtypes = [AioNode]
IsTorqueCellNode = _libraries['control/_pack_ground_telemetry.so'].IsTorqueCellNode
IsTorqueCellNode.restype = ctypes.c_bool
IsTorqueCellNode.argtypes = [AioNode]
IsUnknownNode = _libraries['control/_pack_ground_telemetry.so'].IsUnknownNode
IsUnknownNode.restype = ctypes.c_bool
IsUnknownNode.argtypes = [AioNode]
IsUwbNode = _libraries['control/_pack_ground_telemetry.so'].IsUwbNode
IsUwbNode.restype = ctypes.c_bool
IsUwbNode.argtypes = [AioNode]
IsVisualizerNode = _libraries['control/_pack_ground_telemetry.so'].IsVisualizerNode
IsVisualizerNode.restype = ctypes.c_bool
IsVisualizerNode.argtypes = [AioNode]
AVIONICS_NETWORK_EOP_MESSAGE_TYPE_H_ = True
EopMessageTypeToString = _libraries['control/_pack_ground_telemetry.so'].EopMessageTypeToString
EopMessageTypeToString.restype = POINTER_T(ctypes.c_char)
EopMessageTypeToString.argtypes = [EopMessageType]
EopMessageTypeToShortString = _libraries['control/_pack_ground_telemetry.so'].EopMessageTypeToShortString
EopMessageTypeToShortString.restype = POINTER_T(ctypes.c_char)
EopMessageTypeToShortString.argtypes = [EopMessageType]
IsValidEopMessageType = _libraries['control/_pack_ground_telemetry.so'].IsValidEopMessageType
IsValidEopMessageType.restype = ctypes.c_bool
IsValidEopMessageType.argtypes = [EopMessageType]
StringToEopMessageType = _libraries['control/_pack_ground_telemetry.so'].StringToEopMessageType
...
MessageTypeToString = _libraries['control/_pack_ground_telemetry.so'].MessageTypeToString
MessageTypeToString.restype = POINTER_T(ctypes.c_char)
MessageTypeToString.argtypes = [MessageType]
MessageTypeToShortString = _libraries['control/_pack_ground_telemetry.so'].MessageTypeToShortString
MessageTypeToShortString.restype = POINTER_T(ctypes.c_char)
MessageTypeToShortString.argtypes = [MessageType]
IsValidMessageType = _libraries['control/_pack_ground_telemetry.so'].IsValidMessageType
IsValidMessageType.restype = ctypes.c_bool
IsValidMessageType.argtypes = [MessageType]
StringToMessageType = _libraries['control/_pack_ground_telemetry.so'].StringToMessageType
...
WinchMessageTypeToString = _libraries['control/_pack_ground_telemetry.so'].WinchMessageTypeToString
WinchMessageTypeToString.restype = POINTER_T(ctypes.c_char)
WinchMessageTypeToString.argtypes = [WinchMessageType]
WinchMessageTypeToShortString = _libraries['control/_pack_ground_telemetry.so'].WinchMessageTypeToShortString
WinchMessageTypeToShortString.restype = POINTER_T(ctypes.c_char)
WinchMessageTypeToShortString.argtypes = [WinchMessageType]
IsValidWinchMessageType = _libraries['control/_pack_ground_telemetry.so'].IsValidWinchMessageType
IsValidWinchMessageType.restype = ctypes.c_bool
IsValidWinchMessageType.argtypes = [WinchMessageType]
StringToWinchMessageType = _libraries['control/_pack_ground_telemetry.so'].StringToWinchMessageType
...
__all__ = \
    ...
    'kRotationOrderXzy', 'CrosswindLongitudinalStates',
    'ExperimentState', 'struct_c__SA_TetherCommsStatus',
    ...
    'kPlatformSensorsB', 'struct_c__SA_DumpRoutesRequestMessage',
    'kServoHardwareRevAa', 'kJoystickChannelPitch',
    'kFcMonitorWarning3v3Imu', 'ScoringLimitsParams',
    'kActuatorStateCommandTest', 'kMvlvMonitorWarningVExt',
    'MatVecLeftDivide', 'DiffCircular', 'kGillWindmasterFieldStatus',
    'TetherJoystick', 'kJoystickHardwareForceSigned',
    'AxisAngleToQuat', 'CalParams', 'TetherGsGpsPosition', 'Lpf2Init',
    'kGsAxisStateChangingToA', 'CrosswindNormalGateToString',
    'Ina219Monitor', 'IsMvlvNode', 'Vec2Mult', 'MvlvMonitorError',
    'WingGpsReceiverLabel', 'c__EA_CsMonitorError',
    'struct_c__SA_EncoderCalParams', 'AioMonitorWarning',
    ...
    'c__EA_BridleLabel', 'kAds7828SelectDiffCh5Ch4',
    ...
    'struct_c__SA_Deltas', 'kMessageTypeControlTelemetry',
    'kPlcErrorFlagDetwistServoABad', 'c__EA_LoadcellSensorLabel',
    'SaturateVec3ByScalar', 'kAioNodeRecorderQ7Wing', 'AioHardware',
    'c__EA_ShortStackCommandValue', 'struct_c__SA_GpsTimeMessage',
    'CrosswindLongitudinalInputs', 'kSeptentrioIdGloNav',
    'kNumTransInGates', 'PlatformSensorsMessage',
    'kIna219Adc64Samples', 'struct_c__SA_GpsSatellitesMessage',
    'kAioNodeMotorPbi', 'int_fast64_t', 'kAioNodeMotorPbo',
    'IsUnknownNode', 'NovAtelLogRxConfig', 'GsSystemMode',
    'kLtc6804Dcto3min', 'kShortStackGpioOutputPinForceTripB1',
    'kMotorSbi', 'kAds7828SelectDiffCh3Ch2',
    'kNovAtelSolutionTypeIonofreeFloat', 'Backlash',
    'struct_c__SA_TestResult', 'struct_c__SA_HoverElevatorExperiment',
    ...
    'kNegativeX', 'FlightComputerLabelToFlightComputerAioNode',
    'kMvlvMonitorWarning5v', 'struct_c__SA_CrosswindPowerState',
    'c__EA_TetherPlcProximity', 'kSi7021ResolutionRh8BitTemp12Bit',
    'kLightTailBottom', 'struct_c__SA_GroundStationStatusMessage',
    ...
    'kMessageTypeMotorSetState', 'kCsAnalogInputSfpModAbs',
    ...
    'BattHardware', 'c__EA_HoverTransformGsDownGate', 'SeptentrioId',
    ...
    'TransInLateralParams', 'struct_c__SA_AddressRouteEntry',
    'FcAnalogInput', 'struct_c__SA_SensorLayoutParams',
    'kMcp342xGain4X', 'Mat3Vec3Axpby', 'kMvlvMonitorErrorFilterCap',
    ...
    'c__EA_CoordinateSystem', 'kWingSerial03Hover',
    ...
    'LoadcellSerialParams', 'c__EA_EstimatorVelocitySolutionType',
    ...
    'struct_c__SA_WingBusInternal', 'kFlightModeHoverAscend',
    ...
    'c__EA_SeptentrioPvtMode', 'PackGroundTelemetry',
    'TetherGpsStatus', 'FaaLightStatusMessage',
    'struct_c__SA_PerchAziEstimate', 'VecDot',
    ...
    'ApparentWindSph', 'kMotorSi7021MonitorBoard', 'GroundTelemetry',
    'struct_c__SA_WinchLevelwindStatus',
    ...
    'kCsMonitorErrorPowerNotGood2v5', 'SaturateUint32', 'GsgData',
    'strncmp', 'kMessageTypeServoGetParam',
    ...
    'PolyDer', 'LpfVec3', 'kPositionNoiseAccelX', 'kNumWingImus',
    ...
    'kCrosswindNormalGateSpeed', 'JoystickLabelToString',
    'kSubsysServoA5', 'PortErrorFlag', 'kDiskInfoWriteable',
    'GpsRtcm1084Message', 'kAioAnalogInputPortRssi1',
    'CrosswindInnerState', 'TetherFlightComputerFlag', 'MatArrGemv',
    ...
    'kServoErrorMotorFailure', 'EstimatorPositionGpsState',
    'ControllerLabelToString', 'kAds7828SelectDiffCh4Ch5',
    'kRecorderHardwareRevAa', 'LoadcellStatus',
    ...
    'kFcMonitorWarning3v3', 'kCrosswindLongitudinalStatePitchRate',
    ...
    'kCarrierHardwareTypeMotor', 'DrumLabelToString',
    ...
    'UnpackGroundEstimatorTelemetry', 'Ads7828MonitorConfig',
    'kSeptentrioPvtErrorNoCovergence', 'struct_Mat3',
    'Vec3ToAxisAngle', 'GetGroundTelemetryMessage',
    'kGpsSolutionTypeRtkNarrowInt', 'kMessageTypeEopSlowStatus',
    'DetwistSensorBusInternal', 'QuatMod',
    ...
    'Gs02Params', 'kMvlvMonitorStatusCmdReceived', 'ApplyCal32',
    ...
    'kCrosswindNormalGateFlightMode', 'kCrosswindNormalGateAirspeed',
    ...
    'kAioAnalogVoltagePortRssi2', 'kMotorHardwareOzoneA1',
    'kPositionStateLabelForceSigned', 'kEstimatorVelMeasurementGps',
    'kServoAnalogVoltageLvA', 'kServoAnalogVoltageLvB',
    'struct_c__SA_AioNodeStatus', 'SerialParamsV1',
    'kLoadcellNodeStarboardA', 'kNumCsAnalogVoltages',
    'kTetherMotorControllerTempCapacitor', 'SubsystemLabelToString',
    'kPlcInfoFlagDetwistEnabled', 'c__EA_TetherWindStatus',
    'EstimatorJoystickParams', 'c__EA_RecorderIna219Monitor',
    'CrosswindPowerParams', 'struct_c__SA_Si7021Monitor',
    'kMotorHardwareForceSigned', 'Vec3XzNorm',
    'kMessageTypeMvlvCommand', 'strerror',
    ...
    'Si7021Monitor', 'struct_c__SA_EstimatorAttitudeCorrection3',
    ...
    'EstimatorJoystickState', 'kSubsysServoE2',
    'kGillMetPakFieldNode', 'struct___locale_struct',
    'kIna219Adc16Samples', 'rindex', 'struct_c__SA_CsSerialParams',
    ...
    'MatThinSvDecomp', 'struct_c__SA_NovAtelHeader',
    'kSubsysGroundEstimatorAttitude', 'strcoll_l',
    ...
    'kFlightComputerFlagPitotAltitudeDiag', 'memchr',
    ...
    'kAttitudeStateBiasGZ', 'kAttitudeStateBiasGX',
    ...
    'GroundEstimatorTelemetry', 'IsSaturated',
    ...
    'kFilterTypeBandStop', 'struct_c__SA_Gs02DrumAngles',
    'SeptentrioBlockMeasEpoch', 'int8_t', 'c__EA_TemperatureInfoFlag',
    'kFcMonitorWarning3v3Gps', 'kShortStack', 'TetherDownMessage',
    'kFaultDetectionImuSignalMag', 'Filter', 'VecResize',
    ...
    'kBattStateCommandConnect', 'kEopWingB', 'Ltc6804AuxCh',
    ...
    'Vec2Add', 'GroundPowerTms570LabelToGroundPowerTms570AioNode',
    ...
    'c__EA_HoverDescendGate', 'Vec2NormSquared',
    ...
    'PackGroundEstimatorTelemetry', 'kBattHardwareBigCell18V1',
    ...
    'GroundStationParams', 'TetherGroundAnglesEstimate',
    'struct_c__SA_HoverPositionParams', 'kTetherMotorTempStatorCoil',
    'kBattMcp342xMonitorHeatPlate1', 'ImuData',
    'kGsAxisWarningFlagTorqueLimitNotReady', 'Ars308TargetType',
    'kTetherPlcFlagPlcWarning', 'c__EA_JoystickMonitorStatus',
    'kFaultDetectionPitotSignalStatic', 'kAioSerialParamsCrc',
    'kNovAtelMessageIdHeading', 'kMahonyVecMag', 'BandPass2',
    'kAds7828SelectDiffCh0Ch1', 'kGsImuLabelForceSigned',
    'JoystickSerialParams', 'kNovAtelTimeCoarseSteering',
    'MotorStatusMessage', 'MatArrIsLowerTriangular',
    'struct_c__SA_Bq34z100Monitors', 'PlcWinchCommandMessage',
    'SensorProfileDiag', 'c__EA_TelemetrySnapshotLabel',
    'kHoverTransformGsDownGateZError', 'kMvlvAnalogInput12v',
    'kPitotSensorLabelForceSigned', 'FlightPlanToString', 'VecPtr',
    'MvlvMcp342xMonitor', 'struct_c__SA_BuildInfo',
    'kSubsysLoadcellSensorPort0', 'c__EA_LinalgError',
    'kFcHardwareRevBd', 'kFcHardwareRevBc', 'c__EA_NovAtelTime',
    'kFcHardwareRevBa', 'GroundEstimatorInputMessages', 'uintptr_t',
    'MvlvHardware', 'struct_c__SA_SelfTestMessage',
    'c__EA_Mcp9800Resolution', 'HoverPositionParams',
    'c__EA_RotationOrder', 'ServoSetParamMessage',
    'struct_c__SA_GillDataMetPakMeanWindVelocity',
    'struct_c__SA_EstimatorTetherForceState',
    'CircularAveragingBuffer', 'kTetherNodeFlagPowerGood',
    'struct_c__SA_GroundEstimatorInputMessagesUpdated',
    'struct_c__SA_DrumSensorsMonitorMessage', 'kAttitudeStateBiasGY',
    ...
    'kShortStackMcp342xMonitorMainLo', 'CrosswindState',
    ...
    'kNumFaultDetectionGpsSignals', 'struct_c__SA_AnalogMonitor',
    ...
    'kAioNodeDynoMotorSti', 'c__EA_NovAtelPortMode', 'HoverParams',
    'kAioNodeCmdWebmonitor', 'c__EA_FlightComputerWarning',
    'GpsLabelToString', 'kLtc6804AuxChGpio5', 'MvlvAnalogVoltage',
    'int_fast32_t', 'kFcAnalogInputPortDetect0',
    'kCrosswindLateralInputAileron', 'struct_c__SA_IpAddress',
    'c__EA_Ltc2309MonitorFlag', 'kCrosswindPathPrepareTransitionOut',
    ...
    'kJoystickAnalogInputEepromWp', 'EstimatorTetherForceParams',
    ...
    'struct_c__SA_ControlInput', 'TetherUpMergeState',
    ...
    'kRxAlignmentError', 'kSimulatorLabelForceSigned',
    'kRxSymbolError', 'kCarrierHardwareTypeLoadcell', 'strcoll',
    ...
    'kBattHardwareForceSigned', 'strcmp', 'kLtc6804Rate27kHz',
    ...
    'TransInOutputParams', 'GpsSolutionType', 'Mcp342xMonitors',
    ...
    'kMessageTypeServoSetState', 'struct_c__SA_WinchEstimate',
    ...
    'ShortStackLabelToShortStackAioNode', 'kMvlvMcp342xMonitorIgbt',
    ...
    'kMvlvHardwareSyncRectRevA1', 'kStackingStateForceSigned',
    'kHoverAccelGateRollError', 'kIna219BusVoltage16V',
    'PlcOpenStateDiscreteMotion', 'kSimulatorHitlLevelNone',
    'kCsSi7021MonitorBoard', 'UnpackGroundTelemetry',
    ...
    'c__EA_LoadcellMonitorWarning',
    'struct_c__SA_GroundEstimatorTelemetry', 'kLightLabelForceSigned',
    ...
    'ServoErrorLogEntry', 'StateEstimate', 'kMessageTypeBattCommand',
    'kHoverAscendGateTension', 'kMvlvMonitorStatusFaultRetry',
    'c__EA_GainState', 'kNovAtelTimeFreeWheeling',
    'MvlvAnalogGetConfig', 'GroundEstimatorState',
    'kDynoMotorLabelForceSigned', 'QuatHasNaN', 'kHardwareTypeFc',
    ...
    'kMessageTypeStdio', 'struct_c__SA_PowerSysParams',
    ...
    'kNovAtelSolutionStatusDeltaPos', 'c__EA_BattHardware',
    'PlcTophatLabelToPlcTophatAioNode', 'ServoR22Input', 'HasFault',
    'kRecorderMonitorWarning3v3Sata', 'PlcTophatLabelToString',
    ...
    'kFcAnalogInputVAux', 'ControllerLabelToControllerAioNode',
    'kActuatorStateInit', 'struct_c__SA_PlatformSensorsMessage',
    ...
    'CsAnalogVoltage', 'UdpioParams', 'kCmdFlightSpare', 'DegToRad',
    'kLoadcellMonitorWarningVbattArm', 'kPitotSensorHighSpeed',
    ...
    'kNovAtelPortModeCmr', 'NovAtelLogHeadingRate', 'MaxInt64',
    'Bq34z100OutputData', 'MatTrans', 'Mat3Diag',
    'kNovAtelSolutionTypeSingle', 'Mat2Mult',
    ...
    'c__EA_CrosswindNormalGate', 'struct_c__SA_ExperimentState',
    ...
    'RecorderTms570AioNodeToRecorderTms570Label', 'kBridleStar',
    'c__EA_SensorHitlLevel',
    ...
    'uint_fast8_t', 'kTetherCommsLinkJoystick',
    ...
    'NovAtelDatum', 'kTetherFlightComputerFlagPitotGood',
    ...
    'kPositiveX', 'kCarrierHardwareTypeMvLv', 'kIna219Range160mv',
    'Ina219Adc', 'TransInAttitudeParams',
    ...
    'c__EA_MahonyVecType', 'c__EA_CsAnalogVoltage',
    ...
    'kNumGainStates', 'struct_c__SA_EthernetAddress',
    ...
    'struct_c__SA_GsWeather', 'CsAnalogInput', 'kAioNodeCsDynoA',
    'EstimatorPositionParams', 'kAioNodeCsDynoB',
    'struct_c__SA_GroundTelemetry', 'kGillWindmasterFieldUnits',
    ...
    'kBattAnalogInputLvB', '__assert_fail',
    ...
    'GroundIoAds7828GetConfig', 'struct_c__SA_GroundStationParams',
    ...
    'kTransInGateFlightPlan', 'kAioAnalogInput2v5',
    ...
    'kSeptentrioIdPosLocal', 'HoverPrepTransformGsUpGateToString',
    ...
    'kCrosswindInnerMinAirspeed', 'kAioAnalogInputGtiDetect',
    'kSeptentrioPvtModeBitSolutionMask', 'kGsAxisErrorFlagMotor',
    ...
    'struct_c__SA_EopEthCounters', 'kNumShortStackAnalogInputs',
    ...
    'HoverPrepTransformGsDownGateToString',
    ...
    'DiskInfo', 'IsCmdNode', 'kWingSerial06Hover',
    ...
    'c__EA_ServoMode', 'kServoStatusReset', 'kAioMonitorWarning2v5',
    'c__EA_CsMonitorStatus',
    ...
    'kMotorMonitorWarning12v', '__strtok_r', 'kServoMonitorWarning5v',
    'TetherForceSph', 'kGainStateEStopped', 'c__EA_Ads7828Select',
    'HoverAccelGate', 'Mcp9800Config', 'kControllerLabelForceSigned',
    ...
    'struct_Quat', 'kJoystickAnalogVoltageLvA', 'AccessSwitchStats',
    ...
    'RecorderSerialParams', 'int32_t', 'kLoadcellAnalogInput5v',
    'kMcp342xSps240', 'MatScale', 'ShortStackMonitorError',
    ...
    'GsMotorErrorFlag', 'kMat2Identity', 'GroundIoHardware',
    'kMessageTypeSlowStatus', 'kSeptentrioIdPvtCartesian',
    'kNumShortStacks', 'kNumHoverPayOutGates', 'kNumControllers',
    ...
    'FaultDetectionGpsCompassSignalType', 'Sqrt',
    'kSeptentrioIdAsciiIn', 'struct_c__SA_TetherDownMessage',
    'kNumMahonyVecs', 'kMotorThermalChannelBoard',
    'kMessageTypeLoggerCommand',
    ...
    'kCsSerialParamsCrc', 'struct_c__SA_EstimatorTetherForceParams',
